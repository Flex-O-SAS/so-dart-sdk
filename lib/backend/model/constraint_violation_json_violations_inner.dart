...
@BuiltValue()
abstract class ConstraintViolationJsonViolationsInner implements Built<ConstraintViolationJsonViolationsInner, ConstraintViolationJsonViolationsInnerBuilder> {
  ...
  factory ConstraintViolationJsonViolationsInner([void updates(ConstraintViolationJsonViolationsInnerBuilder b)]) = _$ConstraintViolationJsonViolationsInner;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ConstraintViolationJsonViolationsInnerBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ConstraintViolationJsonViolationsInner> get serializer => _$ConstraintViolationJsonViolationsInnerSerializer();
}

class _$ConstraintViolationJsonViolationsInnerSerializer implements PrimitiveSerializer<ConstraintViolationJsonViolationsInner> {
  @override
  final Iterable<Type> types = const [ConstraintViolationJsonViolationsInner, _$ConstraintViolationJsonViolationsInner];
