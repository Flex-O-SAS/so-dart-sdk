...
part of 'account_jsonld.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$AccountJsonld extends AccountJsonld {
  @override
  final String? login;
  @override
  ...
  @override
  final BuiltList<DeviceJsonld>? devices;
  @override
  ...
  factory _$AccountJsonld([void Function(AccountJsonldBuilder)? updates]) =>
      (new AccountJsonldBuilder()..update(updates))._build();
  ...
  @override
  AccountJsonld rebuild(void Function(AccountJsonldBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  AccountJsonldBuilder toBuilder() => new AccountJsonldBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is AccountJsonld &&
        login == other.login &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'AccountJsonld')
          ..add('login', login)
...
class AccountJsonldBuilder
    implements Builder<AccountJsonld, AccountJsonldBuilder> {
  _$AccountJsonld? _$v;
  ...
  ListBuilder<DeviceJsonld>? _devices;
  ListBuilder<DeviceJsonld> get devices =>
      _$this._devices ??= new ListBuilder<DeviceJsonld>();
  set devices(ListBuilder<DeviceJsonld>? devices) => _$this._devices = devices;
  ...
  AccountJsonldBuilder() {
    AccountJsonld._defaults(this);
  }

  AccountJsonldBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _login = $v.login;
  ...
  @override
  void replace(AccountJsonld other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$AccountJsonld;
  }

  @override
  void update(void Function(AccountJsonldBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  AccountJsonld build() => _build();

  _$AccountJsonld _build() {
    _$AccountJsonld _$result;
    try {
      _$result = _$v ??
          new _$AccountJsonld._(
            login: login,
            password: password,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'AccountJsonld', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
