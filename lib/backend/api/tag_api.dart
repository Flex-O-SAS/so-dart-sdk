...
class TagApi {
  ...
  Future<Response<void>> apiTagsDeleteItem({ 
    required String id,
    ...
    final _path = r'/api-p/tags/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// Returns a [Future] containing a [Response] with a [TagJsonldTagRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TagJsonldTagRead>> apiTagsPatchItem({ 
    required String id,
  ...
  /// Returns a [Future] containing a [Response] with a [TagJsonldTagRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TagJsonldTagRead>> apiTagsPostItem({ 
