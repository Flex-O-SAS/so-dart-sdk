...
part of 'message_jsonld.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$MessageJsonld extends MessageJsonld {
  @override
  ...
  factory _$MessageJsonld([void Function(MessageJsonldBuilder)? updates]) =>
      (new MessageJsonldBuilder()..update(updates))._build();
  ...
  @override
  MessageJsonld rebuild(void Function(MessageJsonldBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MessageJsonldBuilder toBuilder() => new MessageJsonldBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MessageJsonld &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MessageJsonld')
...
class MessageJsonldBuilder
    implements Builder<MessageJsonld, MessageJsonldBuilder> {
  _$MessageJsonld? _$v;
  ...
  MessageJsonldBuilder() {
    MessageJsonld._defaults(this);
  }

  MessageJsonldBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(MessageJsonld other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$MessageJsonld;
  }

  @override
  void update(void Function(MessageJsonldBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  MessageJsonld build() => _build();

  _$MessageJsonld _build() {
    _$MessageJsonld _$result;
    try {
      _$result = _$v ??
          new _$MessageJsonld._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'MessageJsonld', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
