...
/// * [updatedAt] 
@BuiltValue()
abstract class InvoiceCsv implements Built<InvoiceCsv, InvoiceCsvBuilder> {
  ...
  factory InvoiceCsv([void updates(InvoiceCsvBuilder b)]) = _$InvoiceCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InvoiceCsvBuilder b) => b
      ..type = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<InvoiceCsv> get serializer => _$InvoiceCsvSerializer();
}

class _$InvoiceCsvSerializer implements PrimitiveSerializer<InvoiceCsv> {
  @override
  final Iterable<Type> types = const [InvoiceCsv, _$InvoiceCsv];

  @override
  final String wireName = r'InvoiceCsv';
  ...
  void _deserializeProperties(
    ...
    required InvoiceCsvBuilder result,
  ...
  @override
  InvoiceCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = InvoiceCsvBuilder();
