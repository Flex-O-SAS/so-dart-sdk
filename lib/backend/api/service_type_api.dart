...
class ServiceTypeApi {
  ...
  const ServiceTypeApi(this._dio, this._serializers);

  /// Retrieves the collection of ServiceType resources.
  /// Retrieves the collection of ServiceType resources.
  ///
  /// Parameters:
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApiServiceTypeGetCollection200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiServiceTypeGetCollection200Response>> apiServiceTypeGetCollection({ 
    int? page = 1,
    String? reference,
    ...
    final _path = r'/api-p/service_types';
    ...
    ApiServiceTypeGetCollection200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiServiceTypeGetCollection200Response),
      ) as ApiServiceTypeGetCollection200Response;
    ...
    return Response<ApiServiceTypeGetCollection200Response>(
      data: _responseData,
