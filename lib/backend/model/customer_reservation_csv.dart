...
part 'customer_reservation_csv.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class CustomerReservationCsv implements Built<CustomerReservationCsv, CustomerReservationCsvBuilder> {
  ...
  BuiltList<ContractServiceCsv>? get contractServices;

  @BuiltValueField(wireName: r'meetingAttendees')
  BuiltList<MeetingAttendeeCsv>? get meetingAttendees;
  ...
  CustomerReservationCsv._();

  factory CustomerReservationCsv([void updates(CustomerReservationCsvBuilder b)]) = _$CustomerReservationCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CustomerReservationCsvBuilder b) => b
      ..status = 1
      ..type = 1
      ..isFromClientspace = true;

  @BuiltValueSerializer(custom: true)
  static Serializer<CustomerReservationCsv> get serializer => _$CustomerReservationCsvSerializer();
}

class _$CustomerReservationCsvSerializer implements PrimitiveSerializer<CustomerReservationCsv> {
  @override
  final Iterable<Type> types = const [CustomerReservationCsv, _$CustomerReservationCsv];

  @override
  final String wireName = r'CustomerReservationCsv';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CustomerReservationCsv object, {
    ...
    if (object.contractServices != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(ContractServiceCsv)]),
      );
    }
    if (object.meetingAttendees != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(MeetingAttendeeCsv)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required CustomerReservationCsvBuilder result,
      ...
      switch (key) {
        ...
        case r'contractServices':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(ContractServiceCsv)]),
          ) as BuiltList<ContractServiceCsv>;
        ...
        case r'meetingAttendees':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(MeetingAttendeeCsv)]),
          ) as BuiltList<MeetingAttendeeCsv>;
  ...
  @override
  CustomerReservationCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CustomerReservationCsvBuilder();
