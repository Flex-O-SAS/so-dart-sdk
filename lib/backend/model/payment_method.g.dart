...
class _$PaymentMethod extends PaymentMethod {
  @override
  final ClientCenter? clientCenter;
  @override
...
class PaymentMethodBuilder
  ...
  ClientCenterBuilder? _clientCenter;
  ClientCenterBuilder get clientCenter =>
      _$this._clientCenter ??= new ClientCenterBuilder();
  set clientCenter(ClientCenterBuilder? clientCenter) =>
