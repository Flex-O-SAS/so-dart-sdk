...
/// * [updatedAt] 
@BuiltValue()
abstract class ClientJsonld implements Built<ClientJsonld, ClientJsonldBuilder> {
  ...
  BuiltList<CreditJsonld>? get credits;

  @BuiltValueField(wireName: r'clientCenters')
  BuiltList<ClientCenterJsonld>? get clientCenters;
  ...
  BuiltList<ContractDraftJsonld>? get contractDrafts;
  ...
  CollectionJsonld? get requiredInlineDocuments;
  ...
  factory ClientJsonld([void updates(ClientJsonldBuilder b)]) = _$ClientJsonld;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ClientJsonldBuilder b) => b
      ..status = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<ClientJsonld> get serializer => _$ClientJsonldSerializer();
}

class _$ClientJsonldSerializer implements PrimitiveSerializer<ClientJsonld> {
  @override
  final Iterable<Type> types = const [ClientJsonld, _$ClientJsonld];

  @override
  final String wireName = r'ClientJsonld';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.accounts != null) {
      ...
      yield serializers.serialize(
        object.accounts,
        specifiedType: const FullType(BuiltList, [FullType(AccountJsonld)]),
      );
    }
    ...
    if (object.messages != null) {
      ...
      yield serializers.serialize(
        object.messages,
        specifiedType: const FullType(BuiltList, [FullType(MessageJsonld)]),
      );
    }
    if (object.documents != null) {
      ...
      yield serializers.serialize(
        object.documents,
        specifiedType: const FullType(BuiltList, [FullType(DocumentJsonld)]),
      );
    }
    ...
    if (object.credits != null) {
      ...
      yield serializers.serialize(
        object.credits,
        specifiedType: const FullType(BuiltList, [FullType(CreditJsonld)]),
      );
    }
    ...
    if (object.contractDrafts != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(ContractDraftJsonld)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required ClientJsonldBuilder result,
      ...
      switch (key) {
        ...
        case r'contractDrafts':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(ContractDraftJsonld)]),
          ) as BuiltList<ContractDraftJsonld>;
  ...
  @override
  ClientJsonld deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ClientJsonldBuilder();
