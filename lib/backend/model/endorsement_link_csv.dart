...
part 'endorsement_link_csv.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class EndorsementLinkCsv implements Built<EndorsementLinkCsv, EndorsementLinkCsvBuilder> {
  ...
  EndorsementLinkCsv._();

  factory EndorsementLinkCsv([void updates(EndorsementLinkCsvBuilder b)]) = _$EndorsementLinkCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(EndorsementLinkCsvBuilder b) => b
      ..reason = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<EndorsementLinkCsv> get serializer => _$EndorsementLinkCsvSerializer();
}

class _$EndorsementLinkCsvSerializer implements PrimitiveSerializer<EndorsementLinkCsv> {
  @override
  final Iterable<Type> types = const [EndorsementLinkCsv, _$EndorsementLinkCsv];

  @override
  final String wireName = r'EndorsementLinkCsv';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    EndorsementLinkCsv object, {
  ...
  void _deserializeProperties(
    ...
    required EndorsementLinkCsvBuilder result,
  ...
  @override
  EndorsementLinkCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = EndorsementLinkCsvBuilder();
