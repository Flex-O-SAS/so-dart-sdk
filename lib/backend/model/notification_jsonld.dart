...
abstract class NotificationJsonld implements Built<NotificationJsonld, NotificationJsonldBuilder> {
  ...
  BuiltList<RoleJsonld>? get roles;

  @BuiltValueField(wireName: r'centerRoles')
  BuiltList<RoleJsonld>? get centerRoles;

  @BuiltValueField(wireName: r'staffs')
  BuiltList<StaffJsonld>? get staffs;
...
class _$NotificationJsonldSerializer implements PrimitiveSerializer<NotificationJsonld> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.roles != null) {
      ...
      yield serializers.serialize(
        object.roles,
        specifiedType: const FullType(BuiltList, [FullType(RoleJsonld)]),
      );
    }
    ...
    if (object.staffs != null) {
      ...
      yield serializers.serialize(
        object.staffs,
        specifiedType: const FullType(BuiltList, [FullType(StaffJsonld)]),
      );
    }
