...
class _$NotificationJsonld extends NotificationJsonld {
  ...
  @override
  final BuiltList<RoleJsonld>? roles;
  @override
  final BuiltList<RoleJsonld>? centerRoles;
  @override
  final BuiltList<StaffJsonld>? staffs;
  @override
...
class NotificationJsonldBuilder
  ...
  ListBuilder<RoleJsonld>? _roles;
  ListBuilder<RoleJsonld> get roles =>
      _$this._roles ??= new ListBuilder<RoleJsonld>();
  set roles(ListBuilder<RoleJsonld>? roles) => _$this._roles = roles;

  ListBuilder<RoleJsonld>? _centerRoles;
  ListBuilder<RoleJsonld> get centerRoles =>
      _$this._centerRoles ??= new ListBuilder<RoleJsonld>();
  set centerRoles(ListBuilder<RoleJsonld>? centerRoles) =>
      _$this._centerRoles = centerRoles;

  ListBuilder<StaffJsonld>? _staffs;
  ListBuilder<StaffJsonld> get staffs =>
      _$this._staffs ??= new ListBuilder<StaffJsonld>();
  set staffs(ListBuilder<StaffJsonld>? staffs) => _$this._staffs = staffs;
