...
part of 'discount_grid.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DiscountGrid extends DiscountGrid {
  @override
  final String? label;
  @override
  final int? type;
  ...
  @override
  final BuiltList<CommitmentRate>? commitmentRates;
  @override
  final BuiltList<CenterDiscountGrid>? centerDiscountGrids;
  @override
  ...
  factory _$DiscountGrid([void Function(DiscountGridBuilder)? updates]) =>
      (new DiscountGridBuilder()..update(updates))._build();
  ...
  @override
  DiscountGrid rebuild(void Function(DiscountGridBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DiscountGridBuilder toBuilder() => new DiscountGridBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DiscountGrid &&
        label == other.label &&
        type == other.type &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'DiscountGrid')
          ..add('label', label)
          ..add('type', type)
...
class DiscountGridBuilder
    implements Builder<DiscountGrid, DiscountGridBuilder> {
  _$DiscountGrid? _$v;
  ...
  ListBuilder<CommitmentRate>? _commitmentRates;
  ListBuilder<CommitmentRate> get commitmentRates =>
      _$this._commitmentRates ??= new ListBuilder<CommitmentRate>();
  set commitmentRates(ListBuilder<CommitmentRate>? commitmentRates) =>
      _$this._commitmentRates = commitmentRates;

  ListBuilder<CenterDiscountGrid>? _centerDiscountGrids;
  ListBuilder<CenterDiscountGrid> get centerDiscountGrids =>
      _$this._centerDiscountGrids ??= new ListBuilder<CenterDiscountGrid>();
  set centerDiscountGrids(
          ListBuilder<CenterDiscountGrid>? centerDiscountGrids) =>
  ...
  DiscountGridBuilder() {
    DiscountGrid._defaults(this);
  }

  DiscountGridBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _label = $v.label;
      _type = $v.type;
  ...
  @override
  void replace(DiscountGrid other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$DiscountGrid;
  }

  @override
  void update(void Function(DiscountGridBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DiscountGrid build() => _build();

  _$DiscountGrid _build() {
    _$DiscountGrid _$result;
    try {
      _$result = _$v ??
          new _$DiscountGrid._(
            label: label,
            type: type,
            isActive: isActive,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'DiscountGrid', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
