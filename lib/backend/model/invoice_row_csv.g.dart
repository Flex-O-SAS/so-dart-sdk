...
part of 'invoice_row_csv.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$InvoiceRowCsv extends InvoiceRowCsv {
  @override
  final String? period;
  @override
  final num? quantity;
  ...
  factory _$InvoiceRowCsv([void Function(InvoiceRowCsvBuilder)? updates]) =>
      (new InvoiceRowCsvBuilder()..update(updates))._build();
  ...
  @override
  InvoiceRowCsv rebuild(void Function(InvoiceRowCsvBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  InvoiceRowCsvBuilder toBuilder() => new InvoiceRowCsvBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is InvoiceRowCsv &&
        period == other.period &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'InvoiceRowCsv')
          ..add('period', period)
...
class InvoiceRowCsvBuilder
    implements Builder<InvoiceRowCsv, InvoiceRowCsvBuilder> {
  _$InvoiceRowCsv? _$v;
  ...
  InvoiceRowCsvBuilder() {
    InvoiceRowCsv._defaults(this);
  }

  InvoiceRowCsvBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _period = $v.period;
  ...
  @override
  void replace(InvoiceRowCsv other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$InvoiceRowCsv;
  }

  @override
  void update(void Function(InvoiceRowCsvBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  InvoiceRowCsv build() => _build();

  _$InvoiceRowCsv _build() {
    _$InvoiceRowCsv _$result;
    try {
      _$result = _$v ??
          new _$InvoiceRowCsv._(
            period: period,
            quantity: quantity,
            price: price,
            vat: vat,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'InvoiceRowCsv', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
