...
part 'payment_method_csv.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class PaymentMethodCsv implements Built<PaymentMethodCsv, PaymentMethodCsvBuilder> {
  @BuiltValueField(wireName: r'clientCenter')
  ClientCenterCsv? get clientCenter;
  ...
  factory PaymentMethodCsv([void updates(PaymentMethodCsvBuilder b)]) = _$PaymentMethodCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentMethodCsvBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentMethodCsv> get serializer => _$PaymentMethodCsvSerializer();
}

class _$PaymentMethodCsvSerializer implements PrimitiveSerializer<PaymentMethodCsv> {
  @override
  final Iterable<Type> types = const [PaymentMethodCsv, _$PaymentMethodCsv];

  @override
  final String wireName = r'PaymentMethodCsv';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PaymentMethodCsv object, {
    ...
    if (object.clientCenter != null) {
      ...
      yield serializers.serialize(
        object.clientCenter,
        specifiedType: const FullType(ClientCenterCsv),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required PaymentMethodCsvBuilder result,
  ...
  @override
  PaymentMethodCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaymentMethodCsvBuilder();
