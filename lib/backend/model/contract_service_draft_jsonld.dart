...
part 'contract_service_draft_jsonld.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class ContractServiceDraftJsonld implements Built<ContractServiceDraftJsonld, ContractServiceDraftJsonldBuilder> {
  @BuiltValueField(wireName: r'contract')
  ContractDraftJsonld? get contract;
  ...
  CustomServiceDetailDraftJsonld? get customServiceDetail;

  @BuiltValueField(wireName: r'contractServiceUsers')
  BuiltList<ContractServiceUserDraftJsonld>? get contractServiceUsers;
  ...
  ContractServiceDraftJsonld._();

  factory ContractServiceDraftJsonld([void updates(ContractServiceDraftJsonldBuilder b)]) = _$ContractServiceDraftJsonld;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ContractServiceDraftJsonldBuilder b) => b
      ..quantity = 1
      ..type = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<ContractServiceDraftJsonld> get serializer => _$ContractServiceDraftJsonldSerializer();
}

class _$ContractServiceDraftJsonldSerializer implements PrimitiveSerializer<ContractServiceDraftJsonld> {
  @override
  final Iterable<Type> types = const [ContractServiceDraftJsonld, _$ContractServiceDraftJsonld];

  @override
  final String wireName = r'ContractServiceDraftJsonld';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ContractServiceDraftJsonld object, {
    ...
    if (object.contract != null) {
      ...
      yield serializers.serialize(
        object.contract,
        specifiedType: const FullType(ContractDraftJsonld),
      );
    }
    ...
    if (object.customServiceDetail != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType.nullable(CustomServiceDetailDraftJsonld),
      );
    }
    if (object.contractServiceUsers != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(ContractServiceUserDraftJsonld)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required ContractServiceDraftJsonldBuilder result,
      ...
      switch (key) {
        ...
        case r'customServiceDetail':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(CustomServiceDetailDraftJsonld),
          ) as CustomServiceDetailDraftJsonld?;
        ...
        case r'contractServiceUsers':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(ContractServiceUserDraftJsonld)]),
          ) as BuiltList<ContractServiceUserDraftJsonld>;
  ...
  @override
  ContractServiceDraftJsonld deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ContractServiceDraftJsonldBuilder();
