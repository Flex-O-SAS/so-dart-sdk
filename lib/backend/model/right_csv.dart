...
import 'package:so_dart_sdk/backend/model/right_detail_csv.dart';
import 'package:so_dart_sdk/backend/model/role_csv.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'right_csv.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class RightCsv implements Built<RightCsv, RightCsvBuilder> {
  ...
  RightDetailCsv? get rightDetail;
  ...
  factory RightCsv([void updates(RightCsvBuilder b)]) = _$RightCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(RightCsvBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RightCsv> get serializer => _$RightCsvSerializer();
}

class _$RightCsvSerializer implements PrimitiveSerializer<RightCsv> {
  @override
  final Iterable<Type> types = const [RightCsv, _$RightCsv];

  @override
  final String wireName = r'RightCsv';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.rightDetail != null) {
      ...
      yield serializers.serialize(
        object.rightDetail,
        specifiedType: const FullType.nullable(RightDetailCsv),
      );
    }
    if (object.id != null) {
      yield r'id';
  ...
  void _deserializeProperties(
    ...
    required RightCsvBuilder result,
  ...
  @override
  RightCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = RightCsvBuilder();
