...
part of 'event_csv.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$EventCsv extends EventCsv {
  @override
  final int? type;
  @override
  final int? status;
  ...
  factory _$EventCsv([void Function(EventCsvBuilder)? updates]) =>
      (new EventCsvBuilder()..update(updates))._build();
  ...
  @override
  EventCsv rebuild(void Function(EventCsvBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  EventCsvBuilder toBuilder() => new EventCsvBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is EventCsv &&
        type == other.type &&
        status == other.status &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'EventCsv')
          ..add('type', type)
          ..add('status', status)
...
class EventCsvBuilder implements Builder<EventCsv, EventCsvBuilder> {
  _$EventCsv? _$v;
  ...
  EventCsvBuilder() {
    EventCsv._defaults(this);
  }

  EventCsvBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _type = $v.type;
      _status = $v.status;
  ...
  @override
  void replace(EventCsv other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$EventCsv;
  }

  @override
  void update(void Function(EventCsvBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  EventCsv build() => _build();
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'EventCsv', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
