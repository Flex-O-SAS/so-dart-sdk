...
class CompanyApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApiCompaniesGetCollection200Response] as data
  ...
  Future<Response<ApiCompaniesGetCollection200Response>> apiCompaniesGetCollection({ 
    ...
    ApiCompaniesGetCollection200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiCompaniesGetCollection200Response),
      ) as ApiCompaniesGetCollection200Response;
    ...
    return Response<ApiCompaniesGetCollection200Response>(
      data: _responseData,
