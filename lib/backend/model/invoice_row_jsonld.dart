...
part 'invoice_row_jsonld.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class InvoiceRowJsonld implements Built<InvoiceRowJsonld, InvoiceRowJsonldBuilder> {
  ...
  factory InvoiceRowJsonld([void updates(InvoiceRowJsonldBuilder b)]) = _$InvoiceRowJsonld;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(InvoiceRowJsonldBuilder b) => b
      ..type = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<InvoiceRowJsonld> get serializer => _$InvoiceRowJsonldSerializer();
}

class _$InvoiceRowJsonldSerializer implements PrimitiveSerializer<InvoiceRowJsonld> {
  @override
  final Iterable<Type> types = const [InvoiceRowJsonld, _$InvoiceRowJsonld];

  @override
  final String wireName = r'InvoiceRowJsonld';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    InvoiceRowJsonld object, {
  ...
  void _deserializeProperties(
    ...
    required InvoiceRowJsonldBuilder result,
  ...
  @override
  InvoiceRowJsonld deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = InvoiceRowJsonldBuilder();
