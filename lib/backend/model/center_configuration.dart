...
part 'center_configuration.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class CenterConfiguration implements Built<CenterConfiguration, CenterConfigurationBuilder> {
  ...
  CenterConfiguration._();

  factory CenterConfiguration([void updates(CenterConfigurationBuilder b)]) = _$CenterConfiguration;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CenterConfigurationBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CenterConfiguration> get serializer => _$CenterConfigurationSerializer();
}

class _$CenterConfigurationSerializer implements PrimitiveSerializer<CenterConfiguration> {
  @override
  final Iterable<Type> types = const [CenterConfiguration, _$CenterConfiguration];

  @override
  final String wireName = r'CenterConfiguration';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CenterConfiguration object, {
  ...
  void _deserializeProperties(
    ...
    required CenterConfigurationBuilder result,
  ...
  @override
  CenterConfiguration deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CenterConfigurationBuilder();
