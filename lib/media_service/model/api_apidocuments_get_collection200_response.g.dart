...
ApiApidocumentsGetCollection200Response
    _$ApiApidocumentsGetCollection200ResponseFromJson(
        ...
        $checkedCreate(
          ...
          ($checkedConvert) {
            ...
            final val = ApiApidocumentsGetCollection200Response(
              member: $checkedConvert(
                  'member',
                  (v) => (v as List<dynamic>)
                      .map((e) => DocumentJsonldMediaRead.fromJson(
...
Map<String, dynamic> _$ApiApidocumentsGetCollection200ResponseToJson(
        ApiApidocumentsGetCollection200Response instance) =>
    <String, dynamic>{
