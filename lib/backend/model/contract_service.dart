...
/// * [updatedAt] 
@BuiltValue()
abstract class ContractService implements Built<ContractService, ContractServiceBuilder> {
  ...
  CustomServiceDetail? get customServiceDetail;
  ...
  BuiltList<ContractServiceIndexingLog>? get contractServiceIndexingLogs;
  ...
  factory ContractService([void updates(ContractServiceBuilder b)]) = _$ContractService;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ContractServiceBuilder b) => b
      ..quantity = 1
      ..type = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<ContractService> get serializer => _$ContractServiceSerializer();
}

class _$ContractServiceSerializer implements PrimitiveSerializer<ContractService> {
  @override
  final Iterable<Type> types = const [ContractService, _$ContractService];

  @override
  final String wireName = r'ContractService';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.customServiceDetail != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType.nullable(CustomServiceDetail),
      );
    }
    ...
    if (object.contractServiceIndexingLogs != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(ContractServiceIndexingLog)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required ContractServiceBuilder result,
      ...
      switch (key) {
        ...
        case r'contractServiceIndexingLogs':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(ContractServiceIndexingLog)]),
          ) as BuiltList<ContractServiceIndexingLog>;
  ...
  @override
  ContractService deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ContractServiceBuilder();
