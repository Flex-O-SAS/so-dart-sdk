...
/// * [updatedAt] 
@BuiltValue()
abstract class CreditCsv implements Built<CreditCsv, CreditCsvBuilder> {
  ...
  factory CreditCsv([void updates(CreditCsvBuilder b)]) = _$CreditCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CreditCsvBuilder b) => b
      ..status = 1
      ..type = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<CreditCsv> get serializer => _$CreditCsvSerializer();
}

class _$CreditCsvSerializer implements PrimitiveSerializer<CreditCsv> {
  @override
  final Iterable<Type> types = const [CreditCsv, _$CreditCsv];

  @override
  final String wireName = r'CreditCsv';
  ...
  void _deserializeProperties(
    ...
    required CreditCsvBuilder result,
  ...
  @override
  CreditCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CreditCsvBuilder();
