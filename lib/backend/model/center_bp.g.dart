...
part of 'center_bp.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$CenterBp extends CenterBp {
  @override
  final String? center;
  @override
  ...
  factory _$CenterBp([void Function(CenterBpBuilder)? updates]) =>
      (new CenterBpBuilder()..update(updates))._build();
  ...
  @override
  CenterBp rebuild(void Function(CenterBpBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  CenterBpBuilder toBuilder() => new CenterBpBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is CenterBp &&
        center == other.center &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'CenterBp')
          ..add('center', center)
...
class CenterBpBuilder implements Builder<CenterBp, CenterBpBuilder> {
  _$CenterBp? _$v;
  ...
  CenterBpBuilder() {
    CenterBp._defaults(this);
  }

  CenterBpBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _center = $v.center;
  ...
  @override
  void replace(CenterBp other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$CenterBp;
  }

  @override
  void update(void Function(CenterBpBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  CenterBp build() => _build();
