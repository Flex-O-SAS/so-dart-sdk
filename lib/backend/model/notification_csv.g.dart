...
part of 'notification_csv.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$NotificationCsv extends NotificationCsv {
  @override
  ...
  @override
  final BuiltList<RoleCsv>? roles;
  @override
  final BuiltList<RoleCsv>? centerRoles;
  @override
  final BuiltList<StaffCsv>? staffs;
  @override
  ...
  factory _$NotificationCsv([void Function(NotificationCsvBuilder)? updates]) =>
      (new NotificationCsvBuilder()..update(updates))._build();
  ...
  @override
  NotificationCsv rebuild(void Function(NotificationCsvBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  NotificationCsvBuilder toBuilder() =>
      new NotificationCsvBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is NotificationCsv &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'NotificationCsv')
...
class NotificationCsvBuilder
    implements Builder<NotificationCsv, NotificationCsvBuilder> {
  _$NotificationCsv? _$v;
  ...
  ListBuilder<RoleCsv>? _roles;
  ListBuilder<RoleCsv> get roles =>
      _$this._roles ??= new ListBuilder<RoleCsv>();
  set roles(ListBuilder<RoleCsv>? roles) => _$this._roles = roles;

  ListBuilder<RoleCsv>? _centerRoles;
  ListBuilder<RoleCsv> get centerRoles =>
      _$this._centerRoles ??= new ListBuilder<RoleCsv>();
  set centerRoles(ListBuilder<RoleCsv>? centerRoles) =>
      _$this._centerRoles = centerRoles;

  ListBuilder<StaffCsv>? _staffs;
  ListBuilder<StaffCsv> get staffs =>
      _$this._staffs ??= new ListBuilder<StaffCsv>();
  set staffs(ListBuilder<StaffCsv>? staffs) => _$this._staffs = staffs;
  ...
  NotificationCsvBuilder() {
    NotificationCsv._defaults(this);
  }

  NotificationCsvBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(NotificationCsv other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$NotificationCsv;
  }

  @override
  void update(void Function(NotificationCsvBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  NotificationCsv build() => _build();

  _$NotificationCsv _build() {
    _$NotificationCsv _$result;
    try {
      _$result = _$v ??
          new _$NotificationCsv._(
            reference: reference,
            type: type,
            isActive: isActive,
            email: _email?.build(),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'NotificationCsv', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
