...
/// * [updatedAt] 
@BuiltValue()
abstract class BankAccountCsv implements Built<BankAccountCsv, BankAccountCsvBuilder> {
  ...
  BuiltList<PayoutCsv>? get payouts;

  @BuiltValueField(wireName: r'variousOperationLogs')
  BuiltList<VariousOperationLogCsv>? get variousOperationLogs;
  ...
  factory BankAccountCsv([void updates(BankAccountCsvBuilder b)]) = _$BankAccountCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BankAccountCsvBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BankAccountCsv> get serializer => _$BankAccountCsvSerializer();
}

class _$BankAccountCsvSerializer implements PrimitiveSerializer<BankAccountCsv> {
  @override
  final Iterable<Type> types = const [BankAccountCsv, _$BankAccountCsv];

  @override
  final String wireName = r'BankAccountCsv';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    BankAccountCsv object, {
    ...
    if (object.payouts != null) {
      ...
      yield serializers.serialize(
        object.payouts,
        specifiedType: const FullType(BuiltList, [FullType(PayoutCsv)]),
      );
    }
    if (object.variousOperationLogs != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(VariousOperationLogCsv)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required BankAccountCsvBuilder result,
      ...
      switch (key) {
        ...
        case r'variousOperationLogs':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(VariousOperationLogCsv)]),
          ) as BuiltList<VariousOperationLogCsv>;
  ...
  @override
  BankAccountCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BankAccountCsvBuilder();
