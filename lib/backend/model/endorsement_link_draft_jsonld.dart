...
part 'endorsement_link_draft_jsonld.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class EndorsementLinkDraftJsonld implements Built<EndorsementLinkDraftJsonld, EndorsementLinkDraftJsonldBuilder> {
  @BuiltValueField(wireName: r'endorsement')
  ContractDraftJsonld? get endorsement;
  ...
  EndorsementLinkDraftJsonld._();

  factory EndorsementLinkDraftJsonld([void updates(EndorsementLinkDraftJsonldBuilder b)]) = _$EndorsementLinkDraftJsonld;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(EndorsementLinkDraftJsonldBuilder b) => b
      ..reason = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<EndorsementLinkDraftJsonld> get serializer => _$EndorsementLinkDraftJsonldSerializer();
}

class _$EndorsementLinkDraftJsonldSerializer implements PrimitiveSerializer<EndorsementLinkDraftJsonld> {
  @override
  final Iterable<Type> types = const [EndorsementLinkDraftJsonld, _$EndorsementLinkDraftJsonld];

  @override
  final String wireName = r'EndorsementLinkDraftJsonld';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    EndorsementLinkDraftJsonld object, {
  ...
  void _deserializeProperties(
    ...
    required EndorsementLinkDraftJsonldBuilder result,
  ...
  @override
  EndorsementLinkDraftJsonld deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = EndorsementLinkDraftJsonldBuilder();
