...
class SubscriberApi {
  ...
  Future<Response<void>> apiSubscribersDeleteItem({ 
    required String id,
  ...
  /// Retrieves the collection of Subscriber resources.
  /// Retrieves the collection of Subscriber resources.
  ///
  /// Parameters:
  /// * [page] - The collection page number
  /// * [userIdentifier] - 
  /// * [userIdentifierLeftSquareBracketRightSquareBracket] - 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiSubscribersGetCollection200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiSubscribersGetCollection200Response>> apiSubscribersGetCollection({ 
    ...
    return Response<ApiSubscribersGetCollection200Response>(
      data: _responseData,
  ...
  /// Retrieves a Subscriber resource.
  /// Retrieves a Subscriber resource.
  ///
  /// Parameters:
  /// * [id] - Subscriber identifier
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SubscriberJsonldSubscriberRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SubscriberJsonldSubscriberRead>> apiSubscribersGetItem({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    return Response<SubscriberJsonldSubscriberRead>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Creates a Subscriber resource.
  /// Creates a Subscriber resource.
  ///
  /// Parameters:
  /// * [subscriberSubscriberWrite] - The new Subscriber resource
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [SubscriberJsonldSubscriberRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SubscriberJsonldSubscriberRead>> apiSubscribersPostItem({ 
    required SubscriberSubscriberWrite subscriberSubscriberWrite,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(SubscriberSubscriberWrite);
      _bodyData = _serializers.serialize(subscriberSubscriberWrite, specifiedType: _type);
