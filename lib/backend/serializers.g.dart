...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(ApiCustomerReservationsGetCollection200Response.serializer)
      ...
      ..add(CenterCustomerReservationSearch.serializer)
      ...
      ..add(CenterJsonldCustomerReservationSearch.serializer)
      ...
      ..add(CenterPublicCenterReadOpportunityCreateLeadAssetsInner.serializer)
      ..add(CenterReservationRead.serializer)
      ..add(CenterServiceSearch.serializer)
      ..add(ClientCsvCustomerReservationSearch.serializer)
      ..add(ClientCustomerReservationSearch.serializer)
      ..add(ClientJsonldCustomerReservationSearch.serializer)
      ...
      ..add(CustomerReservationCsvCustomerReservationSearch.serializer)
      ..add(
          CustomerReservationCsvCustomerReservationSearchStatusEnum.serializer)
      ..add(CustomerReservationCsvCustomerReservationSearchTypeEnum.serializer)
      ..add(CustomerReservationCsvPublicCustomerReservationRead.serializer)
      ..add(CustomerReservationCsvPublicCustomerReservationReadStatusEnum
          .serializer)
      ..add(CustomerReservationCustomerReservationSearch.serializer)
      ..add(CustomerReservationCustomerReservationSearchStatusEnum.serializer)
      ..add(CustomerReservationCustomerReservationSearchTypeEnum.serializer)
      ..add(CustomerReservationJsonldCustomerReservationSearch.serializer)
      ..add(CustomerReservationJsonldCustomerReservationSearchStatusEnum
          .serializer)
      ..add(
          CustomerReservationJsonldCustomerReservationSearchTypeEnum.serializer)
      ..add(CustomerReservationJsonldPublicCustomerReservationRead.serializer)
      ..add(CustomerReservationJsonldPublicCustomerReservationReadStatusEnum
          .serializer)
      ..add(CustomerReservationPublicCustomerReservationRead.serializer)
      ..add(
          CustomerReservationPublicCustomerReservationReadStatusEnum.serializer)
      ..add(CustomerReservationSumCsvCustomerReservationSumRead.serializer)
      ..add(CustomerReservationSumCustomerReservationSumRead.serializer)
      ..add(CustomerReservationSumJsonldCustomerReservationSumRead.serializer)
      ...
      ..add(IndividualCsvCustomerReservationSearch.serializer)
      ...
      ..add(IndividualCustomerReservationSearch.serializer)
      ...
      ..add(IndividualJsonldCustomerReservationSearch.serializer)
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(CustomerReservationJsonldCustomerReservationSearch)
          ]),
          () => new ListBuilder<
