...
class RuleApi {
  ...
  const RuleApi(this._dio, this._serializers);
  ...
  Future<Response<void>> apiRulesDeleteItem({ 
    required String id,
    ...
    final _path = r'/api-p/rules/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  Future<Response<RuleExecuteBookingResponseDtoJsonldRuleExecuteBooking>> apiRulesExecuteBooking({ 
    ...
    final _path = r'/api-p/rules/execute/booking';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RuleExecuteBookingResponseDtoJsonldRuleExecuteBooking? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RuleExecuteBookingResponseDtoJsonldRuleExecuteBooking),
      ) as RuleExecuteBookingResponseDtoJsonldRuleExecuteBooking;
    ...
    return Response<RuleExecuteBookingResponseDtoJsonldRuleExecuteBooking>(
      data: _responseData,
  ...
  Future<Response<RuleExecuteBookingResponseDtoJsonldRuleExecuteCancelBooking>> apiRulesExecuteCancelBooking({ 
    ...
    final _path = r'/api-p/rules/execute/cancel_booking';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RuleExecuteBookingResponseDtoJsonldRuleExecuteCancelBooking? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RuleExecuteBookingResponseDtoJsonldRuleExecuteCancelBooking),
      ) as RuleExecuteBookingResponseDtoJsonldRuleExecuteCancelBooking;
    ...
    return Response<RuleExecuteBookingResponseDtoJsonldRuleExecuteCancelBooking>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [name] - 
  /// * [ruleType] - 
  /// * [ruleTypeLeftSquareBracketRightSquareBracket] - 
  /// * [ruleAction] - 
  /// * [ruleActionLeftSquareBracketRightSquareBracket] - 
  /// * [expressionsLeftSquareBracketRightSquareBracket] - JSON object expressions, ex (leftSide,TargetCenter,comparator,==,rightSide,1)
  /// * [id] - 
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiRulesGetCollection200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiRulesGetCollection200Response>> apiRulesGetCollection({ 
    int? page = 1,
    String? name,
    String? ruleType,
    BuiltList<String>? ruleTypeLeftSquareBracketRightSquareBracket,
    String? ruleAction,
    BuiltList<String>? ruleActionLeftSquareBracketRightSquareBracket,
    BuiltList<String>? expressionsLeftSquareBracketRightSquareBracket,
    int? id,
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (ruleType != null) r'ruleType': encodeQueryParameter(_serializers, ruleType, const FullType(String)),
      if (ruleTypeLeftSquareBracketRightSquareBracket != null) r'ruleType[]': encodeCollectionQueryParameter<String>(_serializers, ruleTypeLeftSquareBracketRightSquareBracket, const FullType(BuiltList, [FullType(String)]), format: ListFormat.multi,),
      if (ruleAction != null) r'ruleAction': encodeQueryParameter(_serializers, ruleAction, const FullType(String)),
      if (ruleActionLeftSquareBracketRightSquareBracket != null) r'ruleAction[]': encodeCollectionQueryParameter<String>(_serializers, ruleActionLeftSquareBracketRightSquareBracket, const FullType(BuiltList, [FullType(String)]), format: ListFormat.multi,),
      if (expressionsLeftSquareBracketRightSquareBracket != null) r'expressions[]': encodeCollectionQueryParameter<String>(_serializers, expressionsLeftSquareBracketRightSquareBracket, const FullType(BuiltList, [FullType(String)]), format: ListFormat.multi,),
    ...
    ApiRulesGetCollection200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiRulesGetCollection200Response),
      ) as ApiRulesGetCollection200Response;
    ...
    return Response<ApiRulesGetCollection200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RuleJsonldRuleRead>> apiRulesGetItem({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    RuleJsonldRuleRead? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RuleJsonldRuleRead),
    ...
    return Response<RuleJsonldRuleRead>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
