...
class StepApi {
  ...
  const StepApi(this._dio, this._serializers);
  ...
  Future<Response<void>> apiStepDeleteItem({ 
    required String id,
    ...
    final _path = r'/api/steps/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiStepGetCollection200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiStepGetCollection200Response>> apiStepGetCollection({ 
    ...
    ApiStepGetCollection200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiStepGetCollection200Response),
      ) as ApiStepGetCollection200Response;
    ...
    return Response<ApiStepGetCollection200Response>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [StepJsonldStepRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StepJsonldStepRead>> apiStepGetItem({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    StepJsonldStepRead? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(StepJsonldStepRead),
      ) as StepJsonldStepRead;
    ...
    return Response<StepJsonldStepRead>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Creates a Step resource.
  /// Creates a Step resource.
  ///
  /// Parameters:
  /// * [stepStepWrite] - The new Step resource
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [StepJsonldStepRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StepJsonldStepRead>> apiStepPostItem({ 
    required StepStepWrite stepStepWrite,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(StepStepWrite);
      _bodyData = _serializers.serialize(stepStepWrite, specifiedType: _type);
  ...
  /// Updates the Step resource.
  /// Updates the Step resource.
  ///
  /// Parameters:
  /// * [id] - Step identifier
  /// * [stepStepWriteJsonMergePatch] - The updated Step resource
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [StepJsonldStepRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StepJsonldStepRead>> apiStepPutItem({ 
    required String id,
    required StepStepWriteJsonMergePatch stepStepWriteJsonMergePatch,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(StepStepWriteJsonMergePatch);
      _bodyData = _serializers.serialize(stepStepWriteJsonMergePatch, specifiedType: _type);
