...
/// * [reference] 
@BuiltValue()
abstract class StaffAccount implements Built<StaffAccount, StaffAccountBuilder> {
  ...
  factory StaffAccount([void updates(StaffAccountBuilder b)]) = _$StaffAccount;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(StaffAccountBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<StaffAccount> get serializer => _$StaffAccountSerializer();
}

class _$StaffAccountSerializer implements PrimitiveSerializer<StaffAccount> {
  @override
  final Iterable<Type> types = const [StaffAccount, _$StaffAccount];

  @override
  final String wireName = r'StaffAccount';
  ...
  void _deserializeProperties(
    ...
    required StaffAccountBuilder result,
  ...
  @override
  StaffAccount deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = StaffAccountBuilder();
