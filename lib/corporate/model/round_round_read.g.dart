...
part of 'round_round_read.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$RoundRoundRead extends RoundRoundRead {
  @override
  final String? id;
  @override
  final String agent;
  ...
  factory _$RoundRoundRead([void Function(RoundRoundReadBuilder)? updates]) =>
      (new RoundRoundReadBuilder()..update(updates))._build();
  ...
  _$RoundRoundRead._(
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(agent, r'RoundRoundRead', 'agent');
    BuiltValueNullFieldError.checkNotNull(
        agentName, r'RoundRoundRead', 'agentName');
  }

  @override
  RoundRoundRead rebuild(void Function(RoundRoundReadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RoundRoundReadBuilder toBuilder() =>
      new RoundRoundReadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RoundRoundRead &&
        id == other.id &&
        agent == other.agent &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RoundRoundRead')
          ..add('id', id)
          ..add('agent', agent)
...
class RoundRoundReadBuilder
    implements Builder<RoundRoundRead, RoundRoundReadBuilder> {
  _$RoundRoundRead? _$v;
  ...
  RoundRoundReadBuilder() {
    RoundRoundRead._defaults(this);
  }

  RoundRoundReadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _agent = $v.agent;
  ...
  @override
  void replace(RoundRoundRead other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$RoundRoundRead;
  }

  @override
  void update(void Function(RoundRoundReadBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RoundRoundRead build() => _build();

  _$RoundRoundRead _build() {
    _$RoundRoundRead _$result;
    try {
      _$result = _$v ??
          new _$RoundRoundRead._(
            id: id,
            agent: BuiltValueNullFieldError.checkNotNull(
                agent, r'RoundRoundRead', 'agent'),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'RoundRoundRead', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
