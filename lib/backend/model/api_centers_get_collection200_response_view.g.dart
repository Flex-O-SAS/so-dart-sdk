...
ApiCentersGetCollection200ResponseView
    _$ApiCentersGetCollection200ResponseViewFromJson(
            Map<String, dynamic> json) =>
        $checkedCreate(
          'ApiCentersGetCollection200ResponseView',
          json,
          ($checkedConvert) {
            final val = ApiCentersGetCollection200ResponseView(
...
Map<String, dynamic> _$ApiCentersGetCollection200ResponseViewToJson(
        ApiCentersGetCollection200ResponseView instance) =>
    <String, dynamic>{
