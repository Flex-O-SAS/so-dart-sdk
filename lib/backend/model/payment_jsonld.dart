...
/// * [updatedAt] 
@BuiltValue()
abstract class PaymentJsonld implements Built<PaymentJsonld, PaymentJsonldBuilder> {
  ...
  PaymentMethodJsonld? get paymentMethod;
  ...
  factory PaymentJsonld([void updates(PaymentJsonldBuilder b)]) = _$PaymentJsonld;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentJsonldBuilder b) => b
      ..paymentType = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentJsonld> get serializer => _$PaymentJsonldSerializer();
}

class _$PaymentJsonldSerializer implements PrimitiveSerializer<PaymentJsonld> {
  @override
  final Iterable<Type> types = const [PaymentJsonld, _$PaymentJsonld];

  @override
  final String wireName = r'PaymentJsonld';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PaymentJsonld object, {
    ...
    if (object.paymentMethod != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType.nullable(PaymentMethodJsonld),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required PaymentJsonldBuilder result,
  ...
  @override
  PaymentJsonld deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaymentJsonldBuilder();
