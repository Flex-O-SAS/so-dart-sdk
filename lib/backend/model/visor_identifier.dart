...
/// * [updatedAt] 
@BuiltValue()
abstract class VisorIdentifier implements Built<VisorIdentifier, VisorIdentifierBuilder> {
  ...
  factory VisorIdentifier([void updates(VisorIdentifierBuilder b)]) = _$VisorIdentifier;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(VisorIdentifierBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<VisorIdentifier> get serializer => _$VisorIdentifierSerializer();
}

class _$VisorIdentifierSerializer implements PrimitiveSerializer<VisorIdentifier> {
  @override
  final Iterable<Type> types = const [VisorIdentifier, _$VisorIdentifier];

  @override
  final String wireName = r'VisorIdentifier';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    VisorIdentifier object, {
  ...
  void _deserializeProperties(
    ...
    required VisorIdentifierBuilder result,
  ...
  @override
  VisorIdentifier deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = VisorIdentifierBuilder();
