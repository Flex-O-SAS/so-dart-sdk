...
class DocumentApi {
  ...
  Future<Response<void>> apiDocumentsDeleteItem({ 
    required String id,
    ...
    final _path = r'/api/documents/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ApiDocumentsGetCollection200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiDocumentsGetCollection200Response>> apiDocumentsGetCollection({ 
    int? page = 1,
    int? id,
    ...
    ApiDocumentsGetCollection200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiDocumentsGetCollection200Response),
      ) as ApiDocumentsGetCollection200Response;
    ...
    return Response<ApiDocumentsGetCollection200Response>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DocumentJsonldMediaRead>> apiDocumentsGetItem({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(DocumentJsonldMediaRead),
      ) as DocumentJsonldMediaRead;
  ...
  /// Returns a [Future] containing a [Response] with a [DocumentJsonldMediaRead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<DocumentJsonldMediaRead>> apiDocumentsPostItem({ 
    MultipartFile? file,
    JsonObject? metadata,
    Date? beginDate,
    Date? endDate,
