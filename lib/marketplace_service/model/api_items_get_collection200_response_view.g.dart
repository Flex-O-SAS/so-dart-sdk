...
ApiItemsGetCollection200ResponseView
    _$ApiItemsGetCollection200ResponseViewFromJson(Map<String, dynamic> json) =>
        $checkedCreate(
          'ApiItemsGetCollection200ResponseView',
          json,
          ($checkedConvert) {
            final val = ApiItemsGetCollection200ResponseView(
...
Map<String, dynamic> _$ApiItemsGetCollection200ResponseViewToJson(
        ApiItemsGetCollection200ResponseView instance) =>
    <String, dynamic>{
