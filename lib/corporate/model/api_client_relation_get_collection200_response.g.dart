...
ApiClientRelationGetCollection200Response
    _$ApiClientRelationGetCollection200ResponseFromJson(
        ...
        $checkedCreate(
          ...
          ($checkedConvert) {
            ...
            final val = ApiClientRelationGetCollection200Response(
              member: $checkedConvert(
                  'member',
                  (v) => (v as List<dynamic>)
                      .map((e) => ClientRelationJsonld.fromJson(
...
Map<String, dynamic> _$ApiClientRelationGetCollection200ResponseToJson(
        ApiClientRelationGetCollection200Response instance) =>
    <String, dynamic>{
