...
class LanguageApi {
  ...
  const LanguageApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ApiLanguagePublicGetCollection200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ApiLanguagePublicGetCollection200Response>> apiLanguagePublicGetCollection({ 
    int? page = 1,
    String? code,
    ...
    final _path = r'/api-p/public/languages';
    ...
    ApiLanguagePublicGetCollection200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ApiLanguagePublicGetCollection200Response),
      ) as ApiLanguagePublicGetCollection200Response;
    ...
    return Response<ApiLanguagePublicGetCollection200Response>(
      data: _responseData,
  ...
  Future<Response<LanguageJsonldPublicLanguageReadOpportunityCreateLead>> apiLanguagePublicGetItem({ 
    ...
    final _path = r'/api-p/public/languages/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
