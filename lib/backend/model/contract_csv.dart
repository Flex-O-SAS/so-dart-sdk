...
import 'package:so_dart_sdk/backend/model/endorsement_link_csv.dart';
...
import 'package:so_dart_sdk/backend/model/contract_code_csv.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class ContractCsv implements Built<ContractCsv, ContractCsvBuilder> {
  ...
  BuiltList<ContractCodeCsv>? get contractCodes;
  ...
  EndorsementLinkCsv? get endorsementLink;

  @BuiltValueField(wireName: r'parentLink')
  EndorsementLinkCsv? get parentLink;
  ...
  InternalDocumentCsv? get termsOfSales;
  ...
  EndorsementLinkDraftCsv? get parentLinkDraft;
  ...
  factory ContractCsv([void updates(ContractCsvBuilder b)]) = _$ContractCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ContractCsvBuilder b) => b
      ..type = 1
      ..invoicingType = 1
      ..agreementType = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<ContractCsv> get serializer => _$ContractCsvSerializer();
}

class _$ContractCsvSerializer implements PrimitiveSerializer<ContractCsv> {
  @override
  final Iterable<Type> types = const [ContractCsv, _$ContractCsv];

  @override
  final String wireName = r'ContractCsv';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.contractCodes != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(ContractCodeCsv)]),
      );
    }
    if (object.link != null) {
      yield r'link';
    ...
    if (object.solution != null) {
      ...
      yield serializers.serialize(
        object.solution,
        specifiedType: const FullType.nullable(SolutionCsv),
      );
    }
    ...
    if (object.endorsementLink != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType.nullable(EndorsementLinkCsv),
      );
    }
    ...
    if (object.termsOfSales != null) {
      ...
      yield serializers.serialize(
        object.termsOfSales,
        specifiedType: const FullType.nullable(InternalDocumentCsv),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required ContractCsvBuilder result,
  ...
  @override
  ContractCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ContractCsvBuilder();
