...
ApiDevicesGetCollection200ResponseView
    _$ApiDevicesGetCollection200ResponseViewFromJson(
            Map<String, dynamic> json) =>
        $checkedCreate(
          'ApiDevicesGetCollection200ResponseView',
          json,
          ($checkedConvert) {
            final val = ApiDevicesGetCollection200ResponseView(
...
Map<String, dynamic> _$ApiDevicesGetCollection200ResponseViewToJson(
        ApiDevicesGetCollection200ResponseView instance) =>
    <String, dynamic>{
