...
/// * [updatedAt] 
@BuiltValue()
abstract class PresenceLogCsv implements Built<PresenceLogCsv, PresenceLogCsvBuilder> {
  ...
  factory PresenceLogCsv([void updates(PresenceLogCsvBuilder b)]) = _$PresenceLogCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PresenceLogCsvBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PresenceLogCsv> get serializer => _$PresenceLogCsvSerializer();
}

class _$PresenceLogCsvSerializer implements PrimitiveSerializer<PresenceLogCsv> {
  @override
  final Iterable<Type> types = const [PresenceLogCsv, _$PresenceLogCsv];

  @override
  final String wireName = r'PresenceLogCsv';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PresenceLogCsv object, {
  ...
  void _deserializeProperties(
    ...
    required PresenceLogCsvBuilder result,
  ...
  @override
  PresenceLogCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PresenceLogCsvBuilder();
