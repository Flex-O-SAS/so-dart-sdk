...
class _$MeetingAttendee extends MeetingAttendee {
  @override
  ...
  factory _$MeetingAttendee([void Function(MeetingAttendeeBuilder)? updates]) =>
      (new MeetingAttendeeBuilder()..update(updates))._build();
  ...
  @override
  MeetingAttendee rebuild(void Function(MeetingAttendeeBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  MeetingAttendeeBuilder toBuilder() =>
      new MeetingAttendeeBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is MeetingAttendee &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'MeetingAttendee')
...
class MeetingAttendeeBuilder
    implements Builder<MeetingAttendee, MeetingAttendeeBuilder> {
  _$MeetingAttendee? _$v;
  ...
  MeetingAttendeeBuilder() {
    MeetingAttendee._defaults(this);
  }

  MeetingAttendeeBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(MeetingAttendee other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$MeetingAttendee;
  }

  @override
  void update(void Function(MeetingAttendeeBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  MeetingAttendee build() => _build();

  _$MeetingAttendee _build() {
    _$MeetingAttendee _$result;
    try {
      _$result = _$v ??
          new _$MeetingAttendee._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'MeetingAttendee', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
