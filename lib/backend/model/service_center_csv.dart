...
part 'service_center_csv.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class ServiceCenterCsv implements Built<ServiceCenterCsv, ServiceCenterCsvBuilder> {
  ...
  factory ServiceCenterCsv([void updates(ServiceCenterCsvBuilder b)]) = _$ServiceCenterCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ServiceCenterCsvBuilder b) => b
      ..isOnline = true
      ..isAvailable = true;

  @BuiltValueSerializer(custom: true)
  static Serializer<ServiceCenterCsv> get serializer => _$ServiceCenterCsvSerializer();
}

class _$ServiceCenterCsvSerializer implements PrimitiveSerializer<ServiceCenterCsv> {
  @override
  final Iterable<Type> types = const [ServiceCenterCsv, _$ServiceCenterCsv];

  @override
  final String wireName = r'ServiceCenterCsv';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ServiceCenterCsv object, {
  ...
  void _deserializeProperties(
    ...
    required ServiceCenterCsvBuilder result,
  ...
  @override
  ServiceCenterCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ServiceCenterCsvBuilder();
