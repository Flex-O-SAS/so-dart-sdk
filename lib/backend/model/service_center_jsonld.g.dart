...
part of 'service_center_jsonld.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ServiceCenterJsonld extends ServiceCenterJsonld {
  @override
  ...
  factory _$ServiceCenterJsonld(
          [void Function(ServiceCenterJsonldBuilder)? updates]) =>
      (new ServiceCenterJsonldBuilder()..update(updates))._build();

  _$ServiceCenterJsonld._(
      {this.service,
      this.center,
      this.isOnline,
      this.isAvailable,
  ...
  @override
  ServiceCenterJsonld rebuild(
          void Function(ServiceCenterJsonldBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ServiceCenterJsonldBuilder toBuilder() =>
      new ServiceCenterJsonldBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ServiceCenterJsonld &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ServiceCenterJsonld')
          ..add('service', service)
          ..add('center', center)
...
class ServiceCenterJsonldBuilder
    implements Builder<ServiceCenterJsonld, ServiceCenterJsonldBuilder> {
  _$ServiceCenterJsonld? _$v;
  ...
  ServiceCenterJsonldBuilder() {
    ServiceCenterJsonld._defaults(this);
  }

  ServiceCenterJsonldBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _service = $v.service;
      _center = $v.center;
  ...
  @override
  void replace(ServiceCenterJsonld other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ServiceCenterJsonld;
  }

  @override
  void update(void Function(ServiceCenterJsonldBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ServiceCenterJsonld build() => _build();

  _$ServiceCenterJsonld _build() {
    final _$result = _$v ??
        new _$ServiceCenterJsonld._(
          service: service,
          center: center,
          isOnline: isOnline,
