...
part of 'contract_service_draft.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ContractServiceDraft extends ContractServiceDraft {
  @override
  final ContractDraft? contract;
  @override
  ...
  @override
  final CustomServiceDetailDraft? customServiceDetail;
  @override
  final BuiltList<ContractServiceUserDraft>? contractServiceUsers;
  @override
  final int? capacity;
  @override
  ...
  factory _$ContractServiceDraft(
          [void Function(ContractServiceDraftBuilder)? updates]) =>
      (new ContractServiceDraftBuilder()..update(updates))._build();

  _$ContractServiceDraft._(
      {this.contract,
      this.commitment,
      this.owner,
      this.service,
  ...
  @override
  ContractServiceDraft rebuild(
          void Function(ContractServiceDraftBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ContractServiceDraftBuilder toBuilder() =>
      new ContractServiceDraftBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ContractServiceDraft &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ContractServiceDraft')
...
class ContractServiceDraftBuilder
    implements Builder<ContractServiceDraft, ContractServiceDraftBuilder> {
  _$ContractServiceDraft? _$v;

  ContractDraftBuilder? _contract;
  ContractDraftBuilder get contract =>
      _$this._contract ??= new ContractDraftBuilder();
  set contract(ContractDraftBuilder? contract) => _$this._contract = contract;
  ...
  CustomServiceDetailDraftBuilder? _customServiceDetail;
  CustomServiceDetailDraftBuilder get customServiceDetail =>
      _$this._customServiceDetail ??= new CustomServiceDetailDraftBuilder();
  set customServiceDetail(
          CustomServiceDetailDraftBuilder? customServiceDetail) =>
      _$this._customServiceDetail = customServiceDetail;

  ListBuilder<ContractServiceUserDraft>? _contractServiceUsers;
  ListBuilder<ContractServiceUserDraft> get contractServiceUsers =>
      _$this._contractServiceUsers ??=
          new ListBuilder<ContractServiceUserDraft>();
  set contractServiceUsers(
          ListBuilder<ContractServiceUserDraft>? contractServiceUsers) =>
  ...
  ContractServiceDraftBuilder() {
    ContractServiceDraft._defaults(this);
  }

  ContractServiceDraftBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(ContractServiceDraft other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ContractServiceDraft;
  }

  @override
  void update(void Function(ContractServiceDraftBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ContractServiceDraft build() => _build();

  _$ContractServiceDraft _build() {
    _$ContractServiceDraft _$result;
    try {
      _$result = _$v ??
          new _$ContractServiceDraft._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ContractServiceDraft', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
