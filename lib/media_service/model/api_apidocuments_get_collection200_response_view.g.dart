...
ApiApidocumentsGetCollection200ResponseView
    _$ApiApidocumentsGetCollection200ResponseViewFromJson(
            Map<String, dynamic> json) =>
        $checkedCreate(
          'ApiApidocumentsGetCollection200ResponseView',
          json,
          ($checkedConvert) {
            final val = ApiApidocumentsGetCollection200ResponseView(
...
Map<String, dynamic> _$ApiApidocumentsGetCollection200ResponseViewToJson(
        ApiApidocumentsGetCollection200ResponseView instance) =>
    <String, dynamic>{
