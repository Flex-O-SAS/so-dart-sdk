...
part of 'visor_identifier_jsonld.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$VisorIdentifierJsonld extends VisorIdentifierJsonld {
  @override
  ...
  factory _$VisorIdentifierJsonld(
          [void Function(VisorIdentifierJsonldBuilder)? updates]) =>
      (new VisorIdentifierJsonldBuilder()..update(updates))._build();

  _$VisorIdentifierJsonld._(
      {this.visorIndex,
      this.visorClient,
      this.number,
      this.identifierType,
  ...
  @override
  VisorIdentifierJsonld rebuild(
          void Function(VisorIdentifierJsonldBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  VisorIdentifierJsonldBuilder toBuilder() =>
      new VisorIdentifierJsonldBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is VisorIdentifierJsonld &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'VisorIdentifierJsonld')
...
class VisorIdentifierJsonldBuilder
    implements Builder<VisorIdentifierJsonld, VisorIdentifierJsonldBuilder> {
  _$VisorIdentifierJsonld? _$v;
  ...
  VisorIdentifierJsonldBuilder() {
    VisorIdentifierJsonld._defaults(this);
  }

  VisorIdentifierJsonldBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(VisorIdentifierJsonld other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$VisorIdentifierJsonld;
  }

  @override
  void update(void Function(VisorIdentifierJsonldBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  VisorIdentifierJsonld build() => _build();

  _$VisorIdentifierJsonld _build() {
    _$VisorIdentifierJsonld _$result;
    try {
      _$result = _$v ??
          new _$VisorIdentifierJsonld._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'VisorIdentifierJsonld', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
