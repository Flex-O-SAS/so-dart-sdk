...
part 'visor_log_client_jsonld.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class VisorLogClientJsonld implements Built<VisorLogClientJsonld, VisorLogClientJsonldBuilder> {
  @BuiltValueField(wireName: r'visorClient')
  VisorClientJsonld? get visorClient;

  @BuiltValueField(wireName: r'visorIdentifier')
  VisorIdentifierJsonld? get visorIdentifier;

  @BuiltValueField(wireName: r'visorReader')
  VisorReaderJsonld? get visorReader;
  ...
  VisorLogClientJsonld._();

  factory VisorLogClientJsonld([void updates(VisorLogClientJsonldBuilder b)]) = _$VisorLogClientJsonld;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(VisorLogClientJsonldBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<VisorLogClientJsonld> get serializer => _$VisorLogClientJsonldSerializer();
}

class _$VisorLogClientJsonldSerializer implements PrimitiveSerializer<VisorLogClientJsonld> {
  @override
  final Iterable<Type> types = const [VisorLogClientJsonld, _$VisorLogClientJsonld];

  @override
  final String wireName = r'VisorLogClientJsonld';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    VisorLogClientJsonld object, {
    ...
    if (object.visorIdentifier != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType.nullable(VisorIdentifierJsonld),
      );
    }
    if (object.visorReader != null) {
      ...
      yield serializers.serialize(
        object.visorReader,
        specifiedType: const FullType.nullable(VisorReaderJsonld),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required VisorLogClientJsonldBuilder result,
  ...
  @override
  VisorLogClientJsonld deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = VisorLogClientJsonldBuilder();
