...
part of 'service_center_csv.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ServiceCenterCsv extends ServiceCenterCsv {
  @override
  ...
  factory _$ServiceCenterCsv(
          [void Function(ServiceCenterCsvBuilder)? updates]) =>
      (new ServiceCenterCsvBuilder()..update(updates))._build();

  _$ServiceCenterCsv._(
      {this.service,
      this.center,
      this.isOnline,
      this.isAvailable,
  ...
  @override
  ServiceCenterCsv rebuild(void Function(ServiceCenterCsvBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ServiceCenterCsvBuilder toBuilder() =>
      new ServiceCenterCsvBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ServiceCenterCsv &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ServiceCenterCsv')
          ..add('service', service)
          ..add('center', center)
...
class ServiceCenterCsvBuilder
    implements Builder<ServiceCenterCsv, ServiceCenterCsvBuilder> {
  _$ServiceCenterCsv? _$v;
  ...
  ServiceCenterCsvBuilder() {
    ServiceCenterCsv._defaults(this);
  }

  ServiceCenterCsvBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _service = $v.service;
      _center = $v.center;
  ...
  @override
  void replace(ServiceCenterCsv other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ServiceCenterCsv;
  }

  @override
  void update(void Function(ServiceCenterCsvBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ServiceCenterCsv build() => _build();

  _$ServiceCenterCsv _build() {
    final _$result = _$v ??
        new _$ServiceCenterCsv._(
          service: service,
          center: center,
          isOnline: isOnline,
