...
/// * [updatedAt] 
@BuiltValue()
abstract class QuotationCsv implements Built<QuotationCsv, QuotationCsvBuilder> {
  ...
  factory QuotationCsv([void updates(QuotationCsvBuilder b)]) = _$QuotationCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(QuotationCsvBuilder b) => b
      ..state = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<QuotationCsv> get serializer => _$QuotationCsvSerializer();
}

class _$QuotationCsvSerializer implements PrimitiveSerializer<QuotationCsv> {
  @override
  final Iterable<Type> types = const [QuotationCsv, _$QuotationCsv];

  @override
  final String wireName = r'QuotationCsv';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.document != null) {
      ...
      yield serializers.serialize(
        object.document,
        specifiedType: const FullType.nullable(DocumentCsv),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required QuotationCsvBuilder result,
  ...
  @override
  QuotationCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = QuotationCsvBuilder();
