...
part of 'round_tsv_round_read.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$RoundTsvRoundRead extends RoundTsvRoundRead {
  @override
  final String? id;
  @override
  final String agent;
  ...
  factory _$RoundTsvRoundRead(
          [void Function(RoundTsvRoundReadBuilder)? updates]) =>
      (new RoundTsvRoundReadBuilder()..update(updates))._build();

  _$RoundTsvRoundRead._(
      {this.id,
      required this.agent,
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(agent, r'RoundTsvRoundRead', 'agent');
    BuiltValueNullFieldError.checkNotNull(
        agentName, r'RoundTsvRoundRead', 'agentName');
  }

  @override
  RoundTsvRoundRead rebuild(void Function(RoundTsvRoundReadBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RoundTsvRoundReadBuilder toBuilder() =>
      new RoundTsvRoundReadBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is RoundTsvRoundRead &&
        id == other.id &&
        agent == other.agent &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'RoundTsvRoundRead')
          ..add('id', id)
          ..add('agent', agent)
...
class RoundTsvRoundReadBuilder
    implements Builder<RoundTsvRoundRead, RoundTsvRoundReadBuilder> {
  _$RoundTsvRoundRead? _$v;
  ...
  RoundTsvRoundReadBuilder() {
    RoundTsvRoundRead._defaults(this);
  }

  RoundTsvRoundReadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _agent = $v.agent;
  ...
  @override
  void replace(RoundTsvRoundRead other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$RoundTsvRoundRead;
  }

  @override
  void update(void Function(RoundTsvRoundReadBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  RoundTsvRoundRead build() => _build();

  _$RoundTsvRoundRead _build() {
    _$RoundTsvRoundRead _$result;
    try {
      _$result = _$v ??
          new _$RoundTsvRoundRead._(
            id: id,
            agent: BuiltValueNullFieldError.checkNotNull(
                agent, r'RoundTsvRoundRead', 'agent'),
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'RoundTsvRoundRead', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
