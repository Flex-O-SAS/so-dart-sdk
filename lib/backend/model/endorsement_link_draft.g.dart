...
part of 'endorsement_link_draft.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$EndorsementLinkDraft extends EndorsementLinkDraft {
  @override
  final ContractDraft? endorsement;
  @override
  final String? parent;
  @override
  final int? reason;
  ...
  factory _$EndorsementLinkDraft(
          [void Function(EndorsementLinkDraftBuilder)? updates]) =>
      (new EndorsementLinkDraftBuilder()..update(updates))._build();

  _$EndorsementLinkDraft._(
      {this.endorsement,
      this.parent,
      this.reason,
  ...
  @override
  EndorsementLinkDraft rebuild(
          void Function(EndorsementLinkDraftBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  EndorsementLinkDraftBuilder toBuilder() =>
      new EndorsementLinkDraftBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is EndorsementLinkDraft &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'EndorsementLinkDraft')
...
class EndorsementLinkDraftBuilder
    implements Builder<EndorsementLinkDraft, EndorsementLinkDraftBuilder> {
  _$EndorsementLinkDraft? _$v;

  ContractDraftBuilder? _endorsement;
  ContractDraftBuilder get endorsement =>
      _$this._endorsement ??= new ContractDraftBuilder();
  set endorsement(ContractDraftBuilder? endorsement) =>
  ...
  EndorsementLinkDraftBuilder() {
    EndorsementLinkDraft._defaults(this);
  }

  EndorsementLinkDraftBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(EndorsementLinkDraft other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$EndorsementLinkDraft;
  }

  @override
  void update(void Function(EndorsementLinkDraftBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  EndorsementLinkDraft build() => _build();

  _$EndorsementLinkDraft _build() {
    _$EndorsementLinkDraft _$result;
    try {
      _$result = _$v ??
          new _$EndorsementLinkDraft._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'EndorsementLinkDraft', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
