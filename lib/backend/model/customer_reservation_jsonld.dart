...
part 'customer_reservation_jsonld.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class CustomerReservationJsonld implements Built<CustomerReservationJsonld, CustomerReservationJsonldBuilder> {
  ...
  BuiltList<ContractServiceJsonld>? get contractServices;

  @BuiltValueField(wireName: r'meetingAttendees')
  BuiltList<MeetingAttendeeJsonld>? get meetingAttendees;
  ...
  CustomerReservationJsonld._();

  factory CustomerReservationJsonld([void updates(CustomerReservationJsonldBuilder b)]) = _$CustomerReservationJsonld;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CustomerReservationJsonldBuilder b) => b
      ..status = 1
      ..type = 1
      ..isFromClientspace = true;

  @BuiltValueSerializer(custom: true)
  static Serializer<CustomerReservationJsonld> get serializer => _$CustomerReservationJsonldSerializer();
}

class _$CustomerReservationJsonldSerializer implements PrimitiveSerializer<CustomerReservationJsonld> {
  @override
  final Iterable<Type> types = const [CustomerReservationJsonld, _$CustomerReservationJsonld];

  @override
  final String wireName = r'CustomerReservationJsonld';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CustomerReservationJsonld object, {
    ...
    if (object.contractServices != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(ContractServiceJsonld)]),
      );
    }
    if (object.meetingAttendees != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(MeetingAttendeeJsonld)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required CustomerReservationJsonldBuilder result,
      ...
      switch (key) {
        ...
        case r'contractServices':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(ContractServiceJsonld)]),
          ) as BuiltList<ContractServiceJsonld>;
        ...
        case r'meetingAttendees':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(MeetingAttendeeJsonld)]),
          ) as BuiltList<MeetingAttendeeJsonld>;
  ...
  @override
  CustomerReservationJsonld deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CustomerReservationJsonldBuilder();
