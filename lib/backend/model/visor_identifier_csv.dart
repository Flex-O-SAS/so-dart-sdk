...
part 'visor_identifier_csv.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class VisorIdentifierCsv implements Built<VisorIdentifierCsv, VisorIdentifierCsvBuilder> {
  ...
  VisorIdentifierCsv._();

  factory VisorIdentifierCsv([void updates(VisorIdentifierCsvBuilder b)]) = _$VisorIdentifierCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(VisorIdentifierCsvBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<VisorIdentifierCsv> get serializer => _$VisorIdentifierCsvSerializer();
}

class _$VisorIdentifierCsvSerializer implements PrimitiveSerializer<VisorIdentifierCsv> {
  @override
  final Iterable<Type> types = const [VisorIdentifierCsv, _$VisorIdentifierCsv];

  @override
  final String wireName = r'VisorIdentifierCsv';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    VisorIdentifierCsv object, {
  ...
  void _deserializeProperties(
    ...
    required VisorIdentifierCsvBuilder result,
  ...
  @override
  VisorIdentifierCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = VisorIdentifierCsvBuilder();
