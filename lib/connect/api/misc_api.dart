...
class MiscApi {
  ...
  Future<Response<MenuListDto>> menusProviderUuidGet({ 
    ...
    final _path = r'/menus/{provider_uuid}'.replaceAll('{' r'provider_uuid' '}', encodeQueryParameter(_serializers, providerUuid, const FullType(String)).toString());
