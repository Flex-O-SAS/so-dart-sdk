...
ApiCentersGetCollection200Response _$ApiCentersGetCollection200ResponseFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = ApiCentersGetCollection200Response(
          member: $checkedConvert(
              'member',
              (v) => (v as List<dynamic>)
                  .map((e) => CenterJsonldCenterSearch.fromJson(
...
Map<String, dynamic> _$ApiCentersGetCollection200ResponseToJson(
        ApiCentersGetCollection200Response instance) =>
    <String, dynamic>{
