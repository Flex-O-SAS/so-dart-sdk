...
class CenterApi {
  ...
  Future<Response<ApiCentersGetCollection200Response>> apiCentersGetCollection({ 
    ...
    final _queryParameters = <String, dynamic>{
      ...
      if (isActiveFront != null) r'isActiveFront': encodeQueryParameter(_serializers, isActiveFront, const FullType(bool)),
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CenterJsonldPublicCenterReadOpportunityCreateLead] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CenterJsonldPublicCenterReadOpportunityCreateLead>> apiCentersPublicGetItem({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    CenterJsonldPublicCenterReadOpportunityCreateLead? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CenterJsonldPublicCenterReadOpportunityCreateLead),
      ) as CenterJsonldPublicCenterReadOpportunityCreateLead;
    ...
    return Response<CenterJsonldPublicCenterReadOpportunityCreateLead>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
