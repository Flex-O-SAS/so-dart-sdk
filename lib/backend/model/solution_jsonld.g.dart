...
class _$SolutionJsonld extends SolutionJsonld {
  ...
  @override
  final QuotationJsonld? quotation;
  @override
  ...
  factory _$SolutionJsonld([void Function(SolutionJsonldBuilder)? updates]) =>
      (new SolutionJsonldBuilder()..update(updates))._build();
  ...
  @override
  SolutionJsonld rebuild(void Function(SolutionJsonldBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SolutionJsonldBuilder toBuilder() =>
      new SolutionJsonldBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SolutionJsonld &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SolutionJsonld')
...
class SolutionJsonldBuilder
    implements Builder<SolutionJsonld, SolutionJsonldBuilder> {
  _$SolutionJsonld? _$v;
  ...
  set solutionServices(ListBuilder<SolutionServiceJsonld>? solutionServices) =>
  ...
  QuotationJsonldBuilder? _quotation;
  QuotationJsonldBuilder get quotation =>
      _$this._quotation ??= new QuotationJsonldBuilder();
  set quotation(QuotationJsonldBuilder? quotation) =>
  ...
  set scheduleDesktops(ListBuilder<ScheduleDesktopJsonld>? scheduleDesktops) =>
  ...
  CenterPriceJsonldBuilder? _centerPrice;
  CenterPriceJsonldBuilder get centerPrice =>
      _$this._centerPrice ??= new CenterPriceJsonldBuilder();
  ...
  SolutionJsonldBuilder() {
    SolutionJsonld._defaults(this);
  }

  SolutionJsonldBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(SolutionJsonld other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SolutionJsonld;
  }

  @override
  void update(void Function(SolutionJsonldBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SolutionJsonld build() => _build();

  _$SolutionJsonld _build() {
    _$SolutionJsonld _$result;
    try {
      _$result = _$v ??
          new _$SolutionJsonld._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'SolutionJsonld', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
