...
part 'payment_method_jsonld.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class PaymentMethodJsonld implements Built<PaymentMethodJsonld, PaymentMethodJsonldBuilder> {
  @BuiltValueField(wireName: r'clientCenter')
  ClientCenterJsonld? get clientCenter;
  ...
  PaymentMethodJsonld._();

  factory PaymentMethodJsonld([void updates(PaymentMethodJsonldBuilder b)]) = _$PaymentMethodJsonld;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PaymentMethodJsonldBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PaymentMethodJsonld> get serializer => _$PaymentMethodJsonldSerializer();
}

class _$PaymentMethodJsonldSerializer implements PrimitiveSerializer<PaymentMethodJsonld> {
  @override
  final Iterable<Type> types = const [PaymentMethodJsonld, _$PaymentMethodJsonld];

  @override
  final String wireName = r'PaymentMethodJsonld';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PaymentMethodJsonld object, {
    ...
    if (object.clientCenter != null) {
      ...
      yield serializers.serialize(
        object.clientCenter,
        specifiedType: const FullType(ClientCenterJsonld),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required PaymentMethodJsonldBuilder result,
  ...
  @override
  PaymentMethodJsonld deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PaymentMethodJsonldBuilder();
