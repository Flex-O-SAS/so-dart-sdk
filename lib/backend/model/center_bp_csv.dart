...
/// * [updatedAt] 
@BuiltValue()
abstract class CenterBpCsv implements Built<CenterBpCsv, CenterBpCsvBuilder> {
  ...
  factory CenterBpCsv([void updates(CenterBpCsvBuilder b)]) = _$CenterBpCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CenterBpCsvBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CenterBpCsv> get serializer => _$CenterBpCsvSerializer();
}

class _$CenterBpCsvSerializer implements PrimitiveSerializer<CenterBpCsv> {
  @override
  final Iterable<Type> types = const [CenterBpCsv, _$CenterBpCsv];

  @override
  final String wireName = r'CenterBpCsv';
  ...
  void _deserializeProperties(
    ...
    required CenterBpCsvBuilder result,
  ...
  @override
  CenterBpCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CenterBpCsvBuilder();
