...
part of 'quotation_csv.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$QuotationCsv extends QuotationCsv {
  @override
  ...
  factory _$QuotationCsv([void Function(QuotationCsvBuilder)? updates]) =>
      (new QuotationCsvBuilder()..update(updates))._build();
  ...
  @override
  QuotationCsv rebuild(void Function(QuotationCsvBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  QuotationCsvBuilder toBuilder() => new QuotationCsvBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is QuotationCsv &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'QuotationCsv')
...
class QuotationCsvBuilder
    implements Builder<QuotationCsv, QuotationCsvBuilder> {
  _$QuotationCsv? _$v;
  ...
  DocumentCsvBuilder? _document;
  DocumentCsvBuilder get document =>
      _$this._document ??= new DocumentCsvBuilder();
  set document(DocumentCsvBuilder? document) => _$this._document = document;
  ...
  QuotationCsvBuilder() {
    QuotationCsv._defaults(this);
  }

  QuotationCsvBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(QuotationCsv other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$QuotationCsv;
  }

  @override
  void update(void Function(QuotationCsvBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  QuotationCsv build() => _build();

  _$QuotationCsv _build() {
    _$QuotationCsv _$result;
    try {
      _$result = _$v ??
          new _$QuotationCsv._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'QuotationCsv', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
