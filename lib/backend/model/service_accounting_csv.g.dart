...
part of 'service_accounting_csv.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ServiceAccountingCsv extends ServiceAccountingCsv {
  @override
  ...
  factory _$ServiceAccountingCsv(
          [void Function(ServiceAccountingCsvBuilder)? updates]) =>
      (new ServiceAccountingCsvBuilder()..update(updates))._build();

  _$ServiceAccountingCsv._(
      {this.service,
      this.serviceType,
      this.accountingName,
      this.analyticPlan,
  ...
  @override
  ServiceAccountingCsv rebuild(
          void Function(ServiceAccountingCsvBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ServiceAccountingCsvBuilder toBuilder() =>
      new ServiceAccountingCsvBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ServiceAccountingCsv &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ServiceAccountingCsv')
          ..add('service', service)
...
class ServiceAccountingCsvBuilder
    implements Builder<ServiceAccountingCsv, ServiceAccountingCsvBuilder> {
  _$ServiceAccountingCsv? _$v;
  ...
  ServiceAccountingCsvBuilder() {
    ServiceAccountingCsv._defaults(this);
  }

  ServiceAccountingCsvBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _service = $v.service;
  ...
  @override
  void replace(ServiceAccountingCsv other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ServiceAccountingCsv;
  }

  @override
  void update(void Function(ServiceAccountingCsvBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ServiceAccountingCsv build() => _build();

  _$ServiceAccountingCsv _build() {
    final _$result = _$v ??
        new _$ServiceAccountingCsv._(
          service: service,
