...
part of 'wifi_log_csv.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$WifiLogCsv extends WifiLogCsv {
  @override
  ...
  factory _$WifiLogCsv([void Function(WifiLogCsvBuilder)? updates]) =>
      (new WifiLogCsvBuilder()..update(updates))._build();
  ...
  @override
  WifiLogCsv rebuild(void Function(WifiLogCsvBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  WifiLogCsvBuilder toBuilder() => new WifiLogCsvBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is WifiLogCsv &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'WifiLogCsv')
...
class WifiLogCsvBuilder implements Builder<WifiLogCsv, WifiLogCsvBuilder> {
  _$WifiLogCsv? _$v;
  ...
  WifiLogCsvBuilder() {
    WifiLogCsv._defaults(this);
  }

  WifiLogCsvBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(WifiLogCsv other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$WifiLogCsv;
  }

  @override
  void update(void Function(WifiLogCsvBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  WifiLogCsv build() => _build();

  _$WifiLogCsv _build() {
    _$WifiLogCsv _$result;
    try {
      _$result = _$v ??
          new _$WifiLogCsv._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'WifiLogCsv', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
