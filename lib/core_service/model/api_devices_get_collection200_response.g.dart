...
ApiDevicesGetCollection200Response _$ApiDevicesGetCollection200ResponseFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = ApiDevicesGetCollection200Response(
          member: $checkedConvert(
              'member',
              (v) => (v as List<dynamic>)
                  .map((e) => DeviceJsonldDeviceRead.fromJson(
...
Map<String, dynamic> _$ApiDevicesGetCollection200ResponseToJson(
        ApiDevicesGetCollection200Response instance) =>
    <String, dynamic>{
