...
/// * [updatedAt] 
@BuiltValue()
abstract class OpportunityCsv implements Built<OpportunityCsv, OpportunityCsvBuilder> {
  ...
  OpportunityCsvOriginEnum? get origin;
  ...
  OpportunityCsvTypeEnum? get type;
  ...
  factory OpportunityCsv([void updates(OpportunityCsvBuilder b)]) = _$OpportunityCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(OpportunityCsvBuilder b) => b
      ..status = 2
      ..type = OpportunityCsvTypeEnum.valueOf('FULL_DESKTOP');

  @BuiltValueSerializer(custom: true)
  static Serializer<OpportunityCsv> get serializer => _$OpportunityCsvSerializer();
}

class _$OpportunityCsvSerializer implements PrimitiveSerializer<OpportunityCsv> {
  @override
  final Iterable<Type> types = const [OpportunityCsv, _$OpportunityCsv];

  @override
  final String wireName = r'OpportunityCsv';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    OpportunityCsv object, {
    ...
    if (object.origin != null) {
      ...
      yield serializers.serialize(
        object.origin,
        specifiedType: const FullType(OpportunityCsvOriginEnum),
      );
    }
    if (object.utm != null) {
      yield r'utm';
      yield serializers.serialize(
        object.utm,
        specifiedType: const FullType.nullable(UtmCsv),
      );
    }
    ...
    if (object.type != null) {
      ...
      yield serializers.serialize(
        object.type,
        specifiedType: const FullType(OpportunityCsvTypeEnum),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required OpportunityCsvBuilder result,
  ...
  @override
  OpportunityCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = OpportunityCsvBuilder();
...
class OpportunityCsvOriginEnum extends EnumClass {

  /// Origine de l'opportunité
  @BuiltValueEnumConst(wireNumber: 1)
  static const OpportunityCsvOriginEnum number1 = _$opportunityCsvOriginEnum_number1;
  /// Origine de l'opportunité
  @BuiltValueEnumConst(wireNumber: 2)
  static const OpportunityCsvOriginEnum number2 = _$opportunityCsvOriginEnum_number2;
  /// Origine de l'opportunité
  @BuiltValueEnumConst(wireNumber: 3)
  static const OpportunityCsvOriginEnum number3 = _$opportunityCsvOriginEnum_number3;

  static Serializer<OpportunityCsvOriginEnum> get serializer => _$opportunityCsvOriginEnumSerializer;

  const OpportunityCsvOriginEnum._(String name): super(name);

  static BuiltSet<OpportunityCsvOriginEnum> get values => _$opportunityCsvOriginEnumValues;
  static OpportunityCsvOriginEnum valueOf(String name) => _$opportunityCsvOriginEnumValueOf(name);
}

class OpportunityCsvTypeEnum extends EnumClass {

  /// Type de l'opportunité
  @BuiltValueEnumConst(wireName: r'FULL_DESKTOP')
  static const OpportunityCsvTypeEnum FULL_DESKTOP = _$opportunityCsvTypeEnum_FULL_DESKTOP;
  /// Type de l'opportunité
  @BuiltValueEnumConst(wireName: r'FULL_COWORKING')
  static const OpportunityCsvTypeEnum FULL_COWORKING = _$opportunityCsvTypeEnum_FULL_COWORKING;
  /// Type de l'opportunité
  @BuiltValueEnumConst(wireName: r'MEETING')
  static const OpportunityCsvTypeEnum MEETING = _$opportunityCsvTypeEnum_MEETING;
  /// Type de l'opportunité
  @BuiltValueEnumConst(wireName: r'COWORKING')
  static const OpportunityCsvTypeEnum COWORKING = _$opportunityCsvTypeEnum_COWORKING;
  /// Type de l'opportunité
  @BuiltValueEnumConst(wireName: r'OPEN_DESKTOP')
  static const OpportunityCsvTypeEnum OPEN_DESKTOP = _$opportunityCsvTypeEnum_OPEN_DESKTOP;
  /// Type de l'opportunité
  @BuiltValueEnumConst(wireName: r'DOMICILIATION')
  static const OpportunityCsvTypeEnum DOMICILIATION = _$opportunityCsvTypeEnum_DOMICILIATION;

  static Serializer<OpportunityCsvTypeEnum> get serializer => _$opportunityCsvTypeEnumSerializer;

  const OpportunityCsvTypeEnum._(String name): super(name);

  static BuiltSet<OpportunityCsvTypeEnum> get values => _$opportunityCsvTypeEnumValues;
  static OpportunityCsvTypeEnum valueOf(String name) => _$opportunityCsvTypeEnumValueOf(name);
}
