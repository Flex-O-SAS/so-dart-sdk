...
/// * [updatedAt] 
@BuiltValue()
abstract class WifiLog implements Built<WifiLog, WifiLogBuilder> {
  ...
  factory WifiLog([void updates(WifiLogBuilder b)]) = _$WifiLog;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(WifiLogBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<WifiLog> get serializer => _$WifiLogSerializer();
}

class _$WifiLogSerializer implements PrimitiveSerializer<WifiLog> {
  @override
  final Iterable<Type> types = const [WifiLog, _$WifiLog];

  @override
  final String wireName = r'WifiLog';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.wifiStation != null) {
      ...
      yield serializers.serialize(
        object.wifiStation,
        specifiedType: const FullType.nullable(WifiStation),
      );
    }
    if (object.ssid != null) {
      yield r'ssid';
      yield serializers.serialize(
        object.ssid,
        specifiedType: const FullType.nullable(Ssid),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required WifiLogBuilder result,
