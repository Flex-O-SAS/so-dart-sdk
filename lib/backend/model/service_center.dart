...
/// * [updatedAt] 
@BuiltValue()
abstract class ServiceCenter implements Built<ServiceCenter, ServiceCenterBuilder> {
  ...
  factory ServiceCenter([void updates(ServiceCenterBuilder b)]) = _$ServiceCenter;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ServiceCenterBuilder b) => b
      ..isOnline = true
      ..isAvailable = true;

  @BuiltValueSerializer(custom: true)
  static Serializer<ServiceCenter> get serializer => _$ServiceCenterSerializer();
}

class _$ServiceCenterSerializer implements PrimitiveSerializer<ServiceCenter> {
  @override
  final Iterable<Type> types = const [ServiceCenter, _$ServiceCenter];

  @override
  final String wireName = r'ServiceCenter';
  ...
  void _deserializeProperties(
    ...
    required ServiceCenterBuilder result,
  ...
  @override
  ServiceCenter deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ServiceCenterBuilder();
