...
part of 'service_hourly.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ServiceHourly extends ServiceHourly {
  @override
  ...
  factory _$ServiceHourly([void Function(ServiceHourlyBuilder)? updates]) =>
      (new ServiceHourlyBuilder()..update(updates))._build();
  ...
  @override
  ServiceHourly rebuild(void Function(ServiceHourlyBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ServiceHourlyBuilder toBuilder() => new ServiceHourlyBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ServiceHourly &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ServiceHourly')
          ..add('service', service)
...
class ServiceHourlyBuilder
    implements Builder<ServiceHourly, ServiceHourlyBuilder> {
  _$ServiceHourly? _$v;
  ...
  ServiceHourlyBuilder() {
    ServiceHourly._defaults(this);
  }

  ServiceHourlyBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _service = $v.service;
  ...
  @override
  void replace(ServiceHourly other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ServiceHourly;
  }

  @override
  void update(void Function(ServiceHourlyBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ServiceHourly build() => _build();

  _$ServiceHourly _build() {
    final _$result = _$v ??
        new _$ServiceHourly._(
          service: service,
