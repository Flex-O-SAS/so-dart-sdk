...
part 'attribution_log_csv.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class AttributionLogCsv implements Built<AttributionLogCsv, AttributionLogCsvBuilder> {
  ...
  factory AttributionLogCsv([void updates(AttributionLogCsvBuilder b)]) = _$AttributionLogCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AttributionLogCsvBuilder b) => b
      ..opportunityType = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<AttributionLogCsv> get serializer => _$AttributionLogCsvSerializer();
}

class _$AttributionLogCsvSerializer implements PrimitiveSerializer<AttributionLogCsv> {
  @override
  final Iterable<Type> types = const [AttributionLogCsv, _$AttributionLogCsv];

  @override
  final String wireName = r'AttributionLogCsv';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    AttributionLogCsv object, {
  ...
  void _deserializeProperties(
    ...
    required AttributionLogCsvBuilder result,
  ...
  @override
  AttributionLogCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AttributionLogCsvBuilder();
