...
ApiItemsGetCollection200ResponseSearchMappingInner
    _$ApiItemsGetCollection200ResponseSearchMappingInnerFromJson(
            Map<String, dynamic> json) =>
        $checkedCreate(
          'ApiItemsGetCollection200ResponseSearchMappingInner',
          json,
          ($checkedConvert) {
            final val = ApiItemsGetCollection200ResponseSearchMappingInner(
...
Map<String, dynamic> _$ApiItemsGetCollection200ResponseSearchMappingInnerToJson(
        ApiItemsGetCollection200ResponseSearchMappingInner instance) =>
    <String, dynamic>{
