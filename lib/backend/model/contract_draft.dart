...
/// * [updatedAt] 
@BuiltValue()
abstract class ContractDraft implements Built<ContractDraft, ContractDraftBuilder> {
  @BuiltValueField(wireName: r'endorsementLink')
  EndorsementLinkDraft? get endorsementLink;
  ...
  BuiltList<ContractServiceDraft>? get contractServices;
  ...
  factory ContractDraft([void updates(ContractDraftBuilder b)]) = _$ContractDraft;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ContractDraftBuilder b) => b
      ..type = 1
      ..invoicingType = 1
      ..agreementType = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<ContractDraft> get serializer => _$ContractDraftSerializer();
}

class _$ContractDraftSerializer implements PrimitiveSerializer<ContractDraft> {
  @override
  final Iterable<Type> types = const [ContractDraft, _$ContractDraft];

  @override
  final String wireName = r'ContractDraft';
  ...
  void _deserializeProperties(
    ...
    required ContractDraftBuilder result,
  ...
  @override
  ContractDraft deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ContractDraftBuilder();
