...
ProviderJsonldProviderWriteAddressWrite
    _$ProviderJsonldProviderWriteAddressWriteFromJson(
        ...
        $checkedCreate(
          ...
          ($checkedConvert) {
            ...
            final val = ProviderJsonldProviderWriteAddressWrite(
              ...
              address: $checkedConvert(
                  'address',
                  (v) => AddressJsonldProviderWriteAddressWrite.fromJson(
...
Map<String, dynamic> _$ProviderJsonldProviderWriteAddressWriteToJson(
        ProviderJsonldProviderWriteAddressWrite instance) =>
    <String, dynamic>{
