...
part of 'api_centers_get_collection200_response_view.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ApiCentersGetCollection200ResponseView
    extends ApiCentersGetCollection200ResponseView {
  @override
  final String? atId;
  @override
  final String? atType;
  ...
  bool operator ==(Object other) {
    ...
    return other is ApiCentersGetCollection200ResponseView &&
        atId == other.atId &&
        atType == other.atType &&
        first == other.first &&
        last == other.last &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'ApiCentersGetCollection200ResponseView')
          ..add('atId', atId)
          ..add('atType', atType)
          ..add('first', first)
          ..add('last', last)
...
class ApiCentersGetCollection200ResponseViewBuilder
    implements
        Builder<ApiCentersGetCollection200ResponseView,
            ApiCentersGetCollection200ResponseViewBuilder> {
  _$ApiCentersGetCollection200ResponseView? _$v;
  ...
  ApiCentersGetCollection200ResponseViewBuilder() {
    ApiCentersGetCollection200ResponseView._defaults(this);
  }

  ApiCentersGetCollection200ResponseViewBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _atId = $v.atId;
      _atType = $v.atType;
  ...
  @override
  void update(
      void Function(ApiCentersGetCollection200ResponseViewBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ApiCentersGetCollection200ResponseView build() => _build();
