...
/// * [updatedAt] 
@BuiltValue()
abstract class NotificationCsv implements Built<NotificationCsv, NotificationCsvBuilder> {
  ...
  BuiltList<RoleCsv>? get roles;

  @BuiltValueField(wireName: r'centerRoles')
  BuiltList<RoleCsv>? get centerRoles;

  @BuiltValueField(wireName: r'staffs')
  BuiltList<StaffCsv>? get staffs;
  ...
  factory NotificationCsv([void updates(NotificationCsvBuilder b)]) = _$NotificationCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(NotificationCsvBuilder b) => b
      ..type = 1
      ..isActive = true
      ..isInternal = true
      ..isEditable = true;
  ...
  static Serializer<NotificationCsv> get serializer => _$NotificationCsvSerializer();
}

class _$NotificationCsvSerializer implements PrimitiveSerializer<NotificationCsv> {
  @override
  final Iterable<Type> types = const [NotificationCsv, _$NotificationCsv];

  @override
  final String wireName = r'NotificationCsv';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    NotificationCsv object, {
    ...
    if (object.roles != null) {
      ...
      yield serializers.serialize(
        object.roles,
        specifiedType: const FullType(BuiltList, [FullType(RoleCsv)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required NotificationCsvBuilder result,
  ...
  @override
  NotificationCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = NotificationCsvBuilder();
