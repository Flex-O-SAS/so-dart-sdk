...
@BuiltValue()
abstract class AppointmentClientJsonldAppointmentClientSignedRead implements HydraItemBaseSchema, Built<AppointmentClientJsonldAppointmentClientSignedRead, AppointmentClientJsonldAppointmentClientSignedReadBuilder> {
...
class _$AppointmentClientJsonldAppointmentClientSignedReadSerializer implements PrimitiveSerializer<AppointmentClientJsonldAppointmentClientSignedRead> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    yield serializers.serialize(
      object.appointment,
      specifiedType: const FullType(AppointmentJsonldAppointmentClientSignedRead),
    );
