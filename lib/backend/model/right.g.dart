...
class _$Right extends Right {
  ...
  factory _$Right([void Function(RightBuilder)? updates]) =>
      (new RightBuilder()..update(updates))._build();
  ...
  @override
  Right rebuild(void Function(RightBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  RightBuilder toBuilder() => new RightBuilder()..replace(this);
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'Right')
...
class RightBuilder implements Builder<Right, RightBuilder> {
  _$Right? _$v;
  ...
  RightDetailBuilder? _rightDetail;
  RightDetailBuilder get rightDetail =>
      _$this._rightDetail ??= new RightDetailBuilder();
  set rightDetail(RightDetailBuilder? rightDetail) =>
  ...
  RightBuilder() {
    Right._defaults(this);
  }

  RightBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(Right other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$Right;
  }

  @override
  void update(void Function(RightBuilder)? updates) {
    ...
    try {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'Right', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
