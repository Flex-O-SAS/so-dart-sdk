...
class DiscoveryJsonldBuilder
  ...
  set zitadelIssuer(String? zitadelIssuer) =>
  ...
  set zitadelManagerClientId(String? zitadelManagerClientId) =>
      _$this._zitadelManagerClientId = zitadelManagerClientId;

  String? _zitadelOrgId;
  String? get zitadelOrgId => _$this._zitadelOrgId;
  set zitadelOrgId(String? zitadelOrgId) => _$this._zitadelOrgId = zitadelOrgId;
  ...
  set ticketingUrl(String? ticketingUrl) => _$this._ticketingUrl = ticketingUrl;

  String? _marketplaceUrl;
  String? get marketplaceUrl => _$this._marketplaceUrl;
  set marketplaceUrl(String? marketplaceUrl) =>
      _$this._marketplaceUrl = marketplaceUrl;

  String? _corporateUrl;
  String? get corporateUrl => _$this._corporateUrl;
  set corporateUrl(String? corporateUrl) => _$this._corporateUrl = corporateUrl;

  String? _backendUrl;
  String? get backendUrl => _$this._backendUrl;
  set backendUrl(String? backendUrl) => _$this._backendUrl = backendUrl;
  ...
  set coreUrl(String? coreUrl) => _$this._coreUrl = coreUrl;

  String? _growthbookCustomerApiKey;
  String? get growthbookCustomerApiKey => _$this._growthbookCustomerApiKey;
  set growthbookCustomerApiKey(String? growthbookCustomerApiKey) =>
  ...
  set growthbookManagerApiKey(String? growthbookManagerApiKey) =>
