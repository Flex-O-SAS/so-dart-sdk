...
part of 'broker_jsonld.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$BrokerJsonld extends BrokerJsonld {
  @override
  final SourceJsonld? source_;
  @override
  final BuiltList<ActivityJsonld>? activities;
  @override
  final BuiltList<EventJsonld>? events;
  @override
  final String? email;
  @override
  final String? phone;
  ...
  factory _$BrokerJsonld([void Function(BrokerJsonldBuilder)? updates]) =>
      (new BrokerJsonldBuilder()..update(updates))._build();
  ...
  @override
  BrokerJsonld rebuild(void Function(BrokerJsonldBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  BrokerJsonldBuilder toBuilder() => new BrokerJsonldBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is BrokerJsonld &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'BrokerJsonld')
          ..add('source_', source_)
...
class BrokerJsonldBuilder
    implements Builder<BrokerJsonld, BrokerJsonldBuilder> {
  _$BrokerJsonld? _$v;
  ...
  ListBuilder<EventJsonld>? _events;
  ListBuilder<EventJsonld> get events =>
      _$this._events ??= new ListBuilder<EventJsonld>();
  set events(ListBuilder<EventJsonld>? events) => _$this._events = events;
  ...
  BrokerJsonldBuilder() {
    BrokerJsonld._defaults(this);
  }

  BrokerJsonldBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(BrokerJsonld other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$BrokerJsonld;
  }

  @override
  void update(void Function(BrokerJsonldBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  BrokerJsonld build() => _build();

  _$BrokerJsonld _build() {
    _$BrokerJsonld _$result;
    try {
      _$result = _$v ??
          new _$BrokerJsonld._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'BrokerJsonld', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
