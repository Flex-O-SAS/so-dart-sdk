...
DocumentJsonldMediaRead _$DocumentJsonldMediaReadFromJson(
        Map<String, dynamic> json) =>
    $checkedCreate(
      'DocumentJsonldMediaRead',
      json,
      ($checkedConvert) {
        final val = DocumentJsonldMediaRead(
...
Map<String, dynamic> _$DocumentJsonldMediaReadToJson(
        DocumentJsonldMediaRead instance) =>
    <String, dynamic>{
