...
part of 'endorsement_link.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$EndorsementLink extends EndorsementLink {
  @override
  ...
  factory _$EndorsementLink([void Function(EndorsementLinkBuilder)? updates]) =>
      (new EndorsementLinkBuilder()..update(updates))._build();
  ...
  @override
  EndorsementLink rebuild(void Function(EndorsementLinkBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  EndorsementLinkBuilder toBuilder() =>
      new EndorsementLinkBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is EndorsementLink &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'EndorsementLink')
...
class EndorsementLinkBuilder
    implements Builder<EndorsementLink, EndorsementLinkBuilder> {
  _$EndorsementLink? _$v;
  ...
  EndorsementLinkBuilder() {
    EndorsementLink._defaults(this);
  }

  EndorsementLinkBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(EndorsementLink other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$EndorsementLink;
  }

  @override
  void update(void Function(EndorsementLinkBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  EndorsementLink build() => _build();

  _$EndorsementLink _build() {
    final _$result = _$v ??
        new _$EndorsementLink._(
