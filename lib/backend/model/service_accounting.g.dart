...
part of 'service_accounting.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ServiceAccounting extends ServiceAccounting {
  @override
  ...
  factory _$ServiceAccounting(
          [void Function(ServiceAccountingBuilder)? updates]) =>
      (new ServiceAccountingBuilder()..update(updates))._build();

  _$ServiceAccounting._(
      {this.service,
      this.serviceType,
      this.accountingName,
      this.analyticPlan,
  ...
  @override
  ServiceAccounting rebuild(void Function(ServiceAccountingBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ServiceAccountingBuilder toBuilder() =>
      new ServiceAccountingBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ServiceAccounting &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ServiceAccounting')
          ..add('service', service)
...
class ServiceAccountingBuilder
    implements Builder<ServiceAccounting, ServiceAccountingBuilder> {
  _$ServiceAccounting? _$v;
  ...
  ServiceAccountingBuilder() {
    ServiceAccounting._defaults(this);
  }

  ServiceAccountingBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _service = $v.service;
  ...
  @override
  void replace(ServiceAccounting other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ServiceAccounting;
  }

  @override
  void update(void Function(ServiceAccountingBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ServiceAccounting build() => _build();

  _$ServiceAccounting _build() {
    final _$result = _$v ??
        new _$ServiceAccounting._(
          service: service,
