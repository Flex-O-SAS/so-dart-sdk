...
ProviderJsonldTagRead _$ProviderJsonldTagReadFromJson(
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        ...
        final val = ProviderJsonldTagRead(
...
Map<String, dynamic> _$ProviderJsonldTagReadToJson(
        ProviderJsonldTagRead instance) =>
    <String, dynamic>{
