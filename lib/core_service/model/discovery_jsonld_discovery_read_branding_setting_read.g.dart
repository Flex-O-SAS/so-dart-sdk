...
class _$DiscoveryJsonldDiscoveryReadBrandingSettingRead
  ...
  _$DiscoveryJsonldDiscoveryReadBrandingSettingRead._(
    ...
    BuiltValueNullFieldError.checkNotNull(
        atId, r'DiscoveryJsonldDiscoveryReadBrandingSettingRead', 'atId');
    BuiltValueNullFieldError.checkNotNull(
        atType, r'DiscoveryJsonldDiscoveryReadBrandingSettingRead', 'atType');
  }
...
class DiscoveryJsonldDiscoveryReadBrandingSettingReadBuilder
  ...
  set zitadelOrgId(covariant String? zitadelOrgId) =>
      _$this._zitadelOrgId = zitadelOrgId;

  String? _zitadelCustomerClientId;
  String? get zitadelCustomerClientId => _$this._zitadelCustomerClientId;
  set zitadelCustomerClientId(covariant String? zitadelCustomerClientId) =>
  ...
  set mediaUrl(covariant String? mediaUrl) => _$this._mediaUrl = mediaUrl;
  ...
  set availableOnHosts(covariant ListBuilder<String>? availableOnHosts) =>
  ...
  set zitadelManagerClientId(covariant String? zitadelManagerClientId) =>
      _$this._zitadelManagerClientId = zitadelManagerClientId;

  String? _zitadelCustomerWebClientId;
  String? get zitadelCustomerWebClientId => _$this._zitadelCustomerWebClientId;
  set zitadelCustomerWebClientId(
  ...
  set growthbookCustomerApiKey(covariant String? growthbookCustomerApiKey) =>
      _$this._growthbookCustomerApiKey = growthbookCustomerApiKey;

  String? _customer;
  String? get customer => _$this._customer;
  set customer(covariant String? customer) => _$this._customer = customer;
  ...
  @override
  void replace(
      covariant DiscoveryJsonldDiscoveryReadBrandingSettingRead other) {
      ...
      _$result = _$v ??
          new _$DiscoveryJsonldDiscoveryReadBrandingSettingRead._(
            ...
            atId: BuiltValueNullFieldError.checkNotNull(atId,
                r'DiscoveryJsonldDiscoveryReadBrandingSettingRead', 'atId'),
            atType: BuiltValueNullFieldError.checkNotNull(atType,
                r'DiscoveryJsonldDiscoveryReadBrandingSettingRead', 'atType'),
          );
    } catch (_) {
