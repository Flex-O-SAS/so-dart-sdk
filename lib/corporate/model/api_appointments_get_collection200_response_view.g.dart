...
class _$ApiAppointmentsGetCollection200ResponseView
    extends ApiAppointmentsGetCollection200ResponseView {
  @override
  final String? atId;
  @override
  final String? atType;
  ...
  bool operator ==(Object other) {
    ...
    return other is ApiAppointmentsGetCollection200ResponseView &&
        atId == other.atId &&
        atType == other.atType &&
        first == other.first &&
        last == other.last &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(
            r'ApiAppointmentsGetCollection200ResponseView')
          ..add('atId', atId)
          ..add('atType', atType)
          ..add('first', first)
          ..add('last', last)
...
class ApiAppointmentsGetCollection200ResponseViewBuilder
    implements
        Builder<ApiAppointmentsGetCollection200ResponseView,
            ApiAppointmentsGetCollection200ResponseViewBuilder> {
  _$ApiAppointmentsGetCollection200ResponseView? _$v;
  ...
  ApiAppointmentsGetCollection200ResponseViewBuilder() {
    ApiAppointmentsGetCollection200ResponseView._defaults(this);
  }

  ApiAppointmentsGetCollection200ResponseViewBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _atId = $v.atId;
      _atType = $v.atType;
  ...
  @override
  ApiAppointmentsGetCollection200ResponseView build() => _build();
