...
/// * [updatedAt] 
@BuiltValue()
abstract class EventCsv implements Built<EventCsv, EventCsvBuilder> {
  ...
  factory EventCsv([void updates(EventCsvBuilder b)]) = _$EventCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(EventCsvBuilder b) => b
      ..type = 1
      ..status = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<EventCsv> get serializer => _$EventCsvSerializer();
}

class _$EventCsvSerializer implements PrimitiveSerializer<EventCsv> {
  @override
  final Iterable<Type> types = const [EventCsv, _$EventCsv];

  @override
  final String wireName = r'EventCsv';
  ...
  void _deserializeProperties(
    ...
    required EventCsvBuilder result,
  ...
  @override
  EventCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = EventCsvBuilder();
