...
part of 'endorsement_link_draft_csv.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$EndorsementLinkDraftCsv extends EndorsementLinkDraftCsv {
  @override
  final ContractDraftCsv? endorsement;
  @override
  final String? parent;
  @override
  final int? reason;
  ...
  factory _$EndorsementLinkDraftCsv(
          [void Function(EndorsementLinkDraftCsvBuilder)? updates]) =>
      (new EndorsementLinkDraftCsvBuilder()..update(updates))._build();

  _$EndorsementLinkDraftCsv._(
      {this.endorsement,
      this.parent,
      this.reason,
  ...
  @override
  EndorsementLinkDraftCsv rebuild(
          void Function(EndorsementLinkDraftCsvBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  EndorsementLinkDraftCsvBuilder toBuilder() =>
      new EndorsementLinkDraftCsvBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is EndorsementLinkDraftCsv &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'EndorsementLinkDraftCsv')
...
class EndorsementLinkDraftCsvBuilder
    implements
        Builder<EndorsementLinkDraftCsv, EndorsementLinkDraftCsvBuilder> {
  _$EndorsementLinkDraftCsv? _$v;

  ContractDraftCsvBuilder? _endorsement;
  ContractDraftCsvBuilder get endorsement =>
      _$this._endorsement ??= new ContractDraftCsvBuilder();
  set endorsement(ContractDraftCsvBuilder? endorsement) =>
  ...
  EndorsementLinkDraftCsvBuilder() {
    EndorsementLinkDraftCsv._defaults(this);
  }

  EndorsementLinkDraftCsvBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(EndorsementLinkDraftCsv other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$EndorsementLinkDraftCsv;
  }

  @override
  void update(void Function(EndorsementLinkDraftCsvBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  EndorsementLinkDraftCsv build() => _build();

  _$EndorsementLinkDraftCsv _build() {
    _$EndorsementLinkDraftCsv _$result;
    try {
      _$result = _$v ??
          new _$EndorsementLinkDraftCsv._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'EndorsementLinkDraftCsv', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
