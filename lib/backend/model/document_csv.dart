...
/// * [updatedAt] 
@BuiltValue()
abstract class DocumentCsv implements Built<DocumentCsv, DocumentCsvBuilder> {
  ...
  factory DocumentCsv([void updates(DocumentCsvBuilder b)]) = _$DocumentCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(DocumentCsvBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<DocumentCsv> get serializer => _$DocumentCsvSerializer();
}

class _$DocumentCsvSerializer implements PrimitiveSerializer<DocumentCsv> {
  @override
  final Iterable<Type> types = const [DocumentCsv, _$DocumentCsv];

  @override
  final String wireName = r'DocumentCsv';
  ...
  void _deserializeProperties(
    ...
    required DocumentCsvBuilder result,
  ...
  @override
  DocumentCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DocumentCsvBuilder();
