...
/// * [updatedAt] 
@BuiltValue()
abstract class SolutionCsv implements Built<SolutionCsv, SolutionCsvBuilder> {
  ...
  CenterPriceCsv? get centerPrice;

  @BuiltValueField(wireName: r'contractType')
  SolutionCsvContractTypeEnum? get contractType;
  ...
  factory SolutionCsv([void updates(SolutionCsvBuilder b)]) = _$SolutionCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(SolutionCsvBuilder b) => b
      ..state = 2
      ..type = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<SolutionCsv> get serializer => _$SolutionCsvSerializer();
}

class _$SolutionCsvSerializer implements PrimitiveSerializer<SolutionCsv> {
  @override
  final Iterable<Type> types = const [SolutionCsv, _$SolutionCsv];

  @override
  final String wireName = r'SolutionCsv';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.quotation != null) {
      ...
      yield serializers.serialize(
        object.quotation,
        specifiedType: const FullType(QuotationCsv),
      );
    }
    ...
    if (object.discountGrid != null) {
      ...
      yield serializers.serialize(
        object.discountGrid,
        specifiedType: const FullType.nullable(DiscountGridCsv),
      );
    }
    if (object.centerPrice != null) {
      ...
      yield serializers.serialize(
        object.centerPrice,
        specifiedType: const FullType.nullable(CenterPriceCsv),
      );
    }
    if (object.contractType != null) {
      ...
      yield serializers.serialize(
        object.contractType,
        specifiedType: const FullType.nullable(SolutionCsvContractTypeEnum),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required SolutionCsvBuilder result,
      ...
      switch (key) {
        ...
        case r'contractType':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(SolutionCsvContractTypeEnum),
          ) as SolutionCsvContractTypeEnum?;
          if (valueDes == null) continue;
  ...
  @override
  SolutionCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = SolutionCsvBuilder();
...
class SolutionCsvContractTypeEnum extends EnumClass {

  @BuiltValueEnumConst(wireNumber: 1)
  static const SolutionCsvContractTypeEnum number1 = _$solutionCsvContractTypeEnum_number1;
  @BuiltValueEnumConst(wireNumber: 2)
  static const SolutionCsvContractTypeEnum number2 = _$solutionCsvContractTypeEnum_number2;
  @BuiltValueEnumConst(wireNumber: 3)
  static const SolutionCsvContractTypeEnum number3 = _$solutionCsvContractTypeEnum_number3;
  @BuiltValueEnumConst(wireNumber: 4)
  static const SolutionCsvContractTypeEnum number4 = _$solutionCsvContractTypeEnum_number4;
  @BuiltValueEnumConst(wireNumber: 5)
  static const SolutionCsvContractTypeEnum number5 = _$solutionCsvContractTypeEnum_number5;
  @BuiltValueEnumConst(wireNumber: 6)
  static const SolutionCsvContractTypeEnum number6 = _$solutionCsvContractTypeEnum_number6;
  @BuiltValueEnumConst(wireNumber: 7)
  static const SolutionCsvContractTypeEnum number7 = _$solutionCsvContractTypeEnum_number7;

  static Serializer<SolutionCsvContractTypeEnum> get serializer => _$solutionCsvContractTypeEnumSerializer;

  const SolutionCsvContractTypeEnum._(String name): super(name);

  static BuiltSet<SolutionCsvContractTypeEnum> get values => _$solutionCsvContractTypeEnumValues;
  static SolutionCsvContractTypeEnum valueOf(String name) => _$solutionCsvContractTypeEnumValueOf(name);
}
