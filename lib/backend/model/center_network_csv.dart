...
part 'center_network_csv.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class CenterNetworkCsv implements Built<CenterNetworkCsv, CenterNetworkCsvBuilder> {
  ...
  factory CenterNetworkCsv([void updates(CenterNetworkCsvBuilder b)]) = _$CenterNetworkCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(CenterNetworkCsvBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<CenterNetworkCsv> get serializer => _$CenterNetworkCsvSerializer();
}

class _$CenterNetworkCsvSerializer implements PrimitiveSerializer<CenterNetworkCsv> {
  @override
  final Iterable<Type> types = const [CenterNetworkCsv, _$CenterNetworkCsv];

  @override
  final String wireName = r'CenterNetworkCsv';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    CenterNetworkCsv object, {
  ...
  void _deserializeProperties(
    ...
    required CenterNetworkCsvBuilder result,
  ...
  @override
  CenterNetworkCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = CenterNetworkCsvBuilder();
