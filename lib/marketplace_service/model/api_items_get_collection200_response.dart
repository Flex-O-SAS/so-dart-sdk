...
class ApiItemsGetCollection200Response {
  /// Returns a new [ApiItemsGetCollection200Response] instance.
  ...
  final List<ItemJsonldItemReadServiceRead> member;
  ...
  final ApiItemsGetCollection200ResponseSearch? search;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ApiItemsGetCollection200Response &&
      other.member == member &&
  ...
  factory ApiItemsGetCollection200Response.fromJson(Map<String, dynamic> json) => _$ApiItemsGetCollection200ResponseFromJson(json);

  Map<String, dynamic> toJson() => _$ApiItemsGetCollection200ResponseToJson(this);
