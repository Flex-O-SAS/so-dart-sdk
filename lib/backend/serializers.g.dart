...
Serializers _$serializers = (new Serializers().toBuilder()
      ...
      ..add(AccountCsv.serializer)
      ..add(AccountJsonld.serializer)
      ..add(AccountingFileLog.serializer)
      ..add(AccountingFileLogCsv.serializer)
      ..add(AcquisitionCost.serializer)
      ..add(AcquisitionCostCsv.serializer)
      ..add(Activity.serializer)
      ..add(ActivityCsv.serializer)
      ...
      ..add(AttributionLogCsv.serializer)
      ..add(BankAccount.serializer)
      ..add(BankAccountCsv.serializer)
      ..add(BankAccountJsonld.serializer)
      ..add(Center.serializer)
      ..add(CenterAssetsInner.serializer)
      ..add(CenterBay.serializer)
      ..add(CenterBayCsv.serializer)
      ..add(CenterBp.serializer)
      ..add(CenterBpCsv.serializer)
      ..add(CenterCenterSearch.serializer)
      ..add(CenterCluster.serializer)
      ..add(CenterClusterCsv.serializer)
      ..add(CenterConfiguration.serializer)
      ..add(CenterConfigurationCsv.serializer)
      ..add(CenterConnection.serializer)
      ..add(CenterConnectionCsv.serializer)
      ..add(CenterConveniences.serializer)
      ..add(CenterConveniencesCsv.serializer)
      ..add(CenterConveniencesJsonld.serializer)
      ..add(CenterCsv.serializer)
      ..add(CenterCsvCenterSearch.serializer)
      ..add(CenterCsvEnterpriseSearchEnterpriseExport.serializer)
      ..add(CenterCsvEnterpriseSearchEnterpriseRead.serializer)
      ..add(CenterCsvHappeningRead.serializer)
      ..add(CenterCsvIndividualSearch.serializer)
      ..add(CenterCsvIndividualSearchIndividualExport.serializer)
      ..add(CenterCsvPublicCenterReadOpportunityCreateLead.serializer)
      ..add(CenterCsvReservationRead.serializer)
      ..add(CenterCsvServiceSearch.serializer)
      ..add(CenterDiscount.serializer)
      ..add(CenterDiscountCsv.serializer)
      ..add(CenterDiscountGrid.serializer)
      ..add(CenterDiscountGridCsv.serializer)
      ..add(CenterDiscountGridJsonld.serializer)
      ..add(CenterDiscountJsonld.serializer)
      ..add(CenterEnterpriseSearchEnterpriseExport.serializer)
      ..add(CenterEnterpriseSearchEnterpriseRead.serializer)
      ..add(CenterFidensio.serializer)
      ..add(CenterFidensioCsv.serializer)
      ..add(CenterHappeningRead.serializer)
      ..add(CenterIndividualSearch.serializer)
      ..add(CenterIndividualSearchIndividualExport.serializer)
      ..add(CenterIp.serializer)
      ..add(CenterIpCsv.serializer)
      ..add(CenterJsonldCenterSearch.serializer)
      ..add(CenterJsonldEnterpriseSearchEnterpriseExport.serializer)
      ..add(CenterJsonldEnterpriseSearchEnterpriseRead.serializer)
      ..add(CenterJsonldHappeningRead.serializer)
      ..add(CenterJsonldIndividualSearch.serializer)
      ..add(CenterJsonldIndividualSearchIndividualExport.serializer)
      ...
      ..add(CenterNetworkCsv.serializer)
      ..add(CenterOpeningDays.serializer)
      ..add(CenterOpeningDaysCsv.serializer)
      ..add(CenterPlan.serializer)
      ..add(CenterPlanCsv.serializer)
      ..add(CenterPlugin.serializer)
      ..add(CenterPluginCsv.serializer)
      ..add(CenterPrice.serializer)
      ..add(CenterPriceCsv.serializer)
      ..add(CenterPriceJsonld.serializer)
      ..add(CenterPrinter.serializer)
      ..add(CenterPrinterCsv.serializer)
      ...
      ..add(ClientCenterCsv.serializer)
      ..add(ClientCenterJsonld.serializer)
      ..add(ClientCsv.serializer)
      ..add(ClientJsonld.serializer)
      ..add(ClientRequest.serializer)
      ..add(ClientRequestCategory.serializer)
      ..add(ClientRequestCategoryCsv.serializer)
      ..add(ClientRequestCsv.serializer)
      ..add(Collection.serializer)
      ..add(CollectionCsv.serializer)
      ..add(CollectionJsonld.serializer)
      ..add(CollectionKeys.serializer)
      ..add(Commission.serializer)
      ..add(CommissionBonus.serializer)
      ..add(CommissionBonusCsv.serializer)
      ..add(CommissionCsv.serializer)
      ..add(CommissionDetail.serializer)
      ..add(CommissionDetailCsv.serializer)
      ..add(CommissionPlan.serializer)
      ..add(CommissionPlanCsv.serializer)
      ..add(CommissionPlanDistribution.serializer)
      ..add(CommissionPlanDistributionCsv.serializer)
      ..add(CommitmentCsvPublicCommitmentReadOpportunityCreateLead.serializer)
      ..add(
      ...
      ..add(CommitmentRateCsv.serializer)
      ..add(CommitmentRateJsonld.serializer)
      ..add(CompanyCompanySearch.serializer)
      ..add(CompanyCsvCompanySearch.serializer)
      ...
      ..add(ContractCodeCsv.serializer)
      ..add(ContractContractDtoContractPublicRead.serializer)
      ..add(ContractContractDtoCsvContractPublicRead.serializer)
      ...
      ..add(ContractCsv.serializer)
      ..add(ContractCsvContractSearch.serializer)
      ..add(ContractDraft.serializer)
      ..add(ContractDraftCsv.serializer)
      ..add(ContractDraftJsonld.serializer)
      ..add(ContractIndexingLog.serializer)
      ..add(ContractIndexingLogCsv.serializer)
      ...
      ..add(ContractServiceCsv.serializer)
      ..add(ContractServiceCsvContractServiceUserRead.serializer)
      ..add(ContractServiceDraft.serializer)
      ..add(ContractServiceDraftCsv.serializer)
      ..add(ContractServiceDraftJsonld.serializer)
      ..add(ContractServiceIndexingLog.serializer)
      ..add(ContractServiceIndexingLogCsv.serializer)
      ...
      ..add(ContractServiceUserCsvContractServiceUserRead.serializer)
      ..add(ContractServiceUserDraft.serializer)
      ..add(ContractServiceUserDraftCsv.serializer)
      ...
      ..add(CustomServiceDetailDraftCsv.serializer)
      ...
      ..add(EmailCsv.serializer)
      ..add(EmailJsonld.serializer)
      ..add(EmailTemplate.serializer)
      ..add(EmailTemplateCsv.serializer)
      ..add(EmailTemplateJsonld.serializer)
      ..add(EndorsementLink.serializer)
      ..add(EndorsementLinkCsv.serializer)
      ..add(EndorsementLinkDraft.serializer)
      ..add(EndorsementLinkDraftCsv.serializer)
      ..add(EndorsementLinkDraftJsonld.serializer)
      ..add(EnterpriseCsvEnterpriseSearchEnterpriseExport.serializer)
      ..add(EnterpriseCsvEnterpriseSearchEnterpriseRead.serializer)
      ..add(EnterpriseCsvIndividualSearch.serializer)
      ..add(EnterpriseCsvIndividualSearchIndividualExport.serializer)
      ..add(EnterpriseCsvOpportunityCreateLead.serializer)
      ..add(EnterpriseEnterpriseSearchEnterpriseExport.serializer)
      ...
      ..add(EnterpriseIndividualSearchIndividualExport.serializer)
      ..add(EnterpriseJsonldEnterpriseSearchEnterpriseExport.serializer)
      ..add(EnterpriseJsonldEnterpriseSearchEnterpriseRead.serializer)
      ..add(EnterpriseJsonldIndividualSearch.serializer)
      ..add(EnterpriseJsonldIndividualSearchIndividualExport.serializer)
      ...
      ..add(EventCsv.serializer)
      ..add(EventJsonld.serializer)
      ..add(ExpressionCsvExpressionRead.serializer)
      ..add(ExpressionCsvExpressionReadComparatorEnum.serializer)
      ..add(ExpressionCsvExpressionReadLeftSideEnum.serializer)
      ..add(ExpressionCsvRuleRead.serializer)
      ...
      ..add(FloorPlanCsv.serializer)
      ..add(FloorPlanCsvServiceShapeRead.serializer)
      ...
      ..add(GuaranteesCalculationRulesCsvGuaranteesCalculationRulesSearch
          .serializer)
      ..add(
      ...
      ..add(GuaranteesCalculationRulesJsonldGuaranteesCalculationRulesSearch
          .serializer)
      ..add(HappeningCsvHappeningRead.serializer)
      ..add(HappeningCsvHappeningSearch.serializer)
      ...
      ..add(HappeningStaffFeedBackCsv.serializer)
      ...
      ..add(IndexationTypeCsv.serializer)
      ..add(IndividualContractServiceUserRead.serializer)
      ..add(IndividualContractServiceUserWriteJsonMergePatch.serializer)
      ..add(IndividualCsvContractServiceUserRead.serializer)
      ..add(IndividualCsvEnterpriseSearchEnterpriseExport.serializer)
      ..add(IndividualCsvEnterpriseSearchEnterpriseRead.serializer)
      ..add(IndividualCsvIndividualCheckEmail.serializer)
      ..add(IndividualCsvIndividualSearch.serializer)
      ..add(IndividualCsvIndividualSearchIndividualExport.serializer)
      ..add(IndividualCsvOpportunityCreateLead.serializer)
      ..add(IndividualEnterpriseSearchEnterpriseExport.serializer)
      ...
      ..add(IndividualIndividualSearchIndividualExport.serializer)
      ..add(IndividualIndividualWriteJsonMergePatch.serializer)
      ..add(IndividualJsonldContractServiceUserRead.serializer)
      ..add(IndividualJsonldEnterpriseSearchEnterpriseExport.serializer)
      ...
      ..add(IndividualJsonldIndividualSearchIndividualExport.serializer)
      ...
      ..add(InternalDocumentCsv.serializer)
      ..add(Invoice.serializer)
      ..add(InvoiceCsv.serializer)
      ..add(InvoiceCsvInvoiceSearch.serializer)
      ...
      ..add(InvoiceReminderCsv.serializer)
      ..add(InvoiceReminderJsonld.serializer)
      ..add(InvoiceRow.serializer)
      ..add(InvoiceRowCsv.serializer)
      ...
      ..add(OpportunityCsvOpportunitySearch.serializer)
      ..add(OpportunityCsvOriginEnum.serializer)
      ..add(OpportunityCsvTypeEnum.serializer)
      ...
      ..add(OrganizationCsv.serializer)
      ..add(OrganizationSetting.serializer)
      ..add(OrganizationSettingCsv.serializer)
      ..add(Payment.serializer)
      ..add(PaymentCsv.serializer)
      ..add(PaymentJsonld.serializer)
      ..add(PaymentMethod.serializer)
      ..add(PaymentMethodCsv.serializer)
      ..add(PaymentMethodJsonld.serializer)
      ..add(Payout.serializer)
      ..add(PayoutCsv.serializer)
      ..add(PayoutJsonld.serializer)
      ..add(PayoutPayment.serializer)
      ..add(PayoutPaymentCsv.serializer)
      ..add(PayoutPaymentJsonld.serializer)
      ..add(PhoneCall.serializer)
      ..add(PhoneCallCsv.serializer)
      ..add(PhoneCallCsvTypeEnum.serializer)
      ..add(PhoneCallTypeEnum.serializer)
      ..add(PhoneSystem.serializer)
      ..add(PhoneSystemCsv.serializer)
      ..add(PhoneSystemStaff.serializer)
      ..add(PhoneSystemStaffCsv.serializer)
      ..add(Plugin.serializer)
      ..add(PluginCsv.serializer)
      ..add(Prescriber.serializer)
      ..add(PrescriberCsv.serializer)
      ..add(PresenceLog.serializer)
      ..add(PresenceLogCsv.serializer)
      ..add(Quotation.serializer)
      ..add(QuotationCsv.serializer)
      ..add(QuotationJsonld.serializer)
      ..add(Right.serializer)
      ..add(RightCsv.serializer)
      ..add(RightDetail.serializer)
      ..add(RightDetailCsv.serializer)
      ..add(RightDetailJsonld.serializer)
      ..add(RightJsonld.serializer)
      ..add(Role.serializer)
      ..add(RoleCsv.serializer)
      ..add(RoleJsonld.serializer)
      ..add(RuleCsvExpressionRead.serializer)
      ..add(RuleCsvRuleRead.serializer)
      ..add(RuleCsvRuleReadRuleActionEnum.serializer)
      ..add(RuleCsvRuleReadRuleTypeEnum.serializer)
      ..add(RuleExecuteBookingDtoRuleExecuteBooking.serializer)
      ..add(RuleExecuteBookingResponseDtoCsvRuleExecuteBooking.serializer)
      ..add(RuleExecuteBookingResponseDtoCsvRuleExecuteCancelBooking.serializer)
      ...
      ..add(RuleVariableCsvRuleVariablesRead.serializer)
      ..add(RuleVariableJsonldRuleVariablesRead.serializer)
      ..add(RuleVariableRuleVariablesRead.serializer)
      ..add(SavedLabel.serializer)
      ..add(SavedLabelCsv.serializer)
      ..add(SavedLabelCsvReservationRead.serializer)
      ..add(SavedLabelCsvServiceSearch.serializer)
      ...
      ..add(ScheduleDesktopCsv.serializer)
      ..add(ScheduleDesktopJsonld.serializer)
      ..add(Service.serializer)
      ..add(ServiceAccounting.serializer)
      ..add(ServiceAccountingCsv.serializer)
      ..add(ServiceAccountingJsonld.serializer)
      ..add(ServiceCenter.serializer)
      ..add(ServiceCenterCsv.serializer)
      ..add(ServiceCenterCsvReservationRead.serializer)
      ..add(ServiceCenterCsvServiceSearch.serializer)
      ...
      ..add(ServiceCsv.serializer)
      ..add(ServiceCsvReservationRead.serializer)
      ..add(ServiceCsvServiceSearch.serializer)
      ..add(ServiceCsvServiceShapeRead.serializer)
      ..add(ServiceHourly.serializer)
      ..add(ServiceHourlyCsv.serializer)
      ...
      ..add(ServiceShapeCsv.serializer)
      ..add(ServiceShapeCsvServiceShapeRead.serializer)
      ...
      ..add(ServiceTypeCsvGuaranteesCalculationRulesSearch.serializer)
      ..add(ServiceTypeCsvServiceTypeSearch.serializer)
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(AccountCsv)]),
          () => new ListBuilder<AccountCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ContractCsv)]),
          () => new ListBuilder<ContractCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(MessageCsv)]),
          () => new ListBuilder<MessageCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(DocumentCsv)]),
          () => new ListBuilder<DocumentCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ActivityCsv)]),
          () => new ListBuilder<ActivityCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CreditCsv)]),
          () => new ListBuilder<CreditCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ClientCenterCsv)]),
          () => new ListBuilder<ClientCenterCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(LitigationCsv)]),
          () => new ListBuilder<LitigationCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(SsidUserCsv)]),
          () => new ListBuilder<SsidUserCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(PaymentCsv)]),
          () => new ListBuilder<PaymentCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ContractDraftCsv)]),
          () => new ListBuilder<ContractDraftCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<String>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(SolutionCsv)]),
          () => new ListBuilder<SolutionCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(String)]),
          () => new ListBuilder<String>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(EventCsv)]),
          () => new ListBuilder<EventCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CenterPriceCsv)]),
          () => new ListBuilder<CenterPriceCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ClientRequestCsv)]),
          () => new ListBuilder<ClientRequestCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(InvoiceReminderCsv)]),
          () => new ListBuilder<InvoiceReminderCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(String)]),
          () => new ListBuilder<String>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CustomerReservationCsv)]),
          () => new ListBuilder<CustomerReservationCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(AttributionLogCsv)]),
          () => new ListBuilder<AttributionLogCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(String)]),
          () => new ListBuilder<String>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(HappeningStaffFeedBackCsv)]),
          () => new ListBuilder<HappeningStaffFeedBackCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CommissionCsv)]),
          () => new ListBuilder<CommissionCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(PhoneCallCsv)]),
          () => new ListBuilder<PhoneCallCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(PhoneSystemStaffCsv)]),
          () => new ListBuilder<PhoneSystemStaffCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CommissionPlanDistributionCsv)]),
          () => new ListBuilder<CommissionPlanDistributionCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ContractDraftCsv)]),
          () => new ListBuilder<ContractDraftCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(NotificationCsv)]),
          () => new ListBuilder<NotificationCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(StaffCenterCsv)]),
          () => new ListBuilder<StaffCenterCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ActivityJsonld)]),
          () => new ListBuilder<ActivityJsonld>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CenterConveniencesCsv)]),
          () => new ListBuilder<CenterConveniencesCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CenterConveniencesJsonld)]),
          () => new ListBuilder<CenterConveniencesJsonld>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CenterCsv)]),
          () => new ListBuilder<CenterCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(StaffCsv)]),
          () => new ListBuilder<StaffCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(AttributionLogCsv)]),
          () => new ListBuilder<AttributionLogCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<String>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CenterPluginCsv)]),
          () => new ListBuilder<CenterPluginCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(String)]),
          () => new ListBuilder<String>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<SsidUserCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(WifiLogCsv)]),
          () => new ListBuilder<WifiLogCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ClientCenterJsonld)]),
          () => new ListBuilder<ClientCenterJsonld>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(ClientRequestCategoryCsv)]),
          () => new ListBuilder<ClientRequestCategoryCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CommissionDetailCsv)]),
          () => new ListBuilder<CommissionDetailCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CommissionDetailCsv)]),
          () => new ListBuilder<CommissionDetailCsv>())
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<ContractCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(InvoiceCsv)]),
          () => new ListBuilder<InvoiceCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ContractCsv)]),
          () => new ListBuilder<ContractCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(QuotationCsv)]),
          () => new ListBuilder<QuotationCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ContractJsonld)]),
          () => new ListBuilder<ContractJsonld>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(ContractServiceDraftCsv)]),
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(ContractServiceUserDraftCsv)]),
          () => new ListBuilder<ContractServiceUserDraftCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList,
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CreditLinkCsv)]),
          () => new ListBuilder<CreditLinkCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(PayoutPaymentCsv)]),
          () => new ListBuilder<PayoutPaymentCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<Activity>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CreditRowCsv)]),
          () => new ListBuilder<CreditRowCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CreditRowCsv)]),
          () => new ListBuilder<CreditRowCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<String>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(DeviceCsv)]),
          () => new ListBuilder<DeviceCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(String)]),
          () => new ListBuilder<String>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(DiscountRateCsv)]),
          () => new ListBuilder<DiscountRateCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ContractCsv)]),
          () => new ListBuilder<ContractCsv>())
      ..addBuilderFactory(
          ...
          () => new ListBuilder<QuotationCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CenterDiscountCsv)]),
          () => new ListBuilder<CenterDiscountCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(DiscountGridCsv)]),
          () => new ListBuilder<DiscountGridCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<Notification>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(EmailTemplateCsv)]),
          () => new ListBuilder<EmailTemplateCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(NotificationCsv)]),
          () => new ListBuilder<NotificationCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(EnterpriseCsvEnterpriseSearchEnterpriseRead)
          ]),
          () => new ListBuilder<EnterpriseCsvEnterpriseSearchEnterpriseRead>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(EnterpriseCsvIndividualSearch)]),
          () => new ListBuilder<EnterpriseCsvIndividualSearch>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(EnterpriseCsvIndividualSearchIndividualExport)
          ]),
          () =>
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(EnterpriseIndividualSearchIndividualExport)
          ]),
          () => new ListBuilder<EnterpriseIndividualSearchIndividualExport>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(EnterpriseJsonldEnterpriseSearchEnterpriseExport)
          ]),
          () => new ListBuilder<
              EnterpriseJsonldEnterpriseSearchEnterpriseExport>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(EnterpriseJsonldIndividualSearchIndividualExport)
          ]),
          () => new ListBuilder<
              EnterpriseJsonldIndividualSearchIndividualExport>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(ExpressionCsvRuleRead)]),
          () => new ListBuilder<ExpressionCsvRuleRead>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(String)]),
          () => new ListBuilder<String>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(IndividualJsonldEnterpriseSearchEnterpriseExport)
          ]),
          () => new ListBuilder<
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(IndividualJsonldIndividualSearchIndividualExport)
          ]),
          () => new ListBuilder<
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(InternalDocumentCsv)]),
          () => new ListBuilder<InternalDocumentCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(ContractIndexingLogCsv)]),
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<String>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(InvoiceRowCsv)]),
          () => new ListBuilder<InvoiceRowCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(ContractServiceIndexingLogCsv)]),
          () => new ListBuilder<ContractServiceIndexingLogCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(String)]),
          () => new ListBuilder<String>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<Opportunity>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(OpportunityCsv)]),
          () => new ListBuilder<OpportunityCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList,
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(OrganizationSettingCsv)]),
          () => new ListBuilder<OrganizationSettingCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ModuleCsv)]),
          () => new ListBuilder<ModuleCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(Payment)]),
          () => new ListBuilder<Payment>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(VariousOperationLogCsv)]),
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(PaymentMethodCsv)]),
          () => new ListBuilder<PaymentMethodCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(SsidCsv)]),
          () => new ListBuilder<SsidCsv>())
      ..addBuilderFactory(
          const FullType(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<VariousOperationLog>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(PayoutCsv)]),
          () => new ListBuilder<PayoutCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(VariousOperationLogCsv)]),
          () => new ListBuilder<VariousOperationLogCsv>())
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<Plugin>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(PluginCsv)]),
          () => new ListBuilder<PluginCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(PluginCsv)]),
          () => new ListBuilder<PluginCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(RightCsv)]),
          () => new ListBuilder<RightCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(RoleCsv)]),
          () => new ListBuilder<RoleCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(RoleCsv)]),
          () => new ListBuilder<RoleCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<String>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(SavedLabelCsv)]),
          () => new ListBuilder<SavedLabelCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(SavedLabelCsvReservationRead)]),
          () => new ListBuilder<SavedLabelCsvReservationRead>())
      ..addBuilderFactory(
          const FullType(BuiltList,
              const [const FullType(ServiceCenterCsvReservationRead)]),
          () => new ListBuilder<ServiceCenterCsvReservationRead>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(SavedLabelCsvServiceSearch)]),
          () => new ListBuilder<SavedLabelCsvServiceSearch>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(ServiceCenterCsvServiceSearch)]),
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ScheduleDesktopCsv)]),
          () => new ListBuilder<ScheduleDesktopCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(String)]),
          () => new ListBuilder<String>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(SolutionServiceCsv)]),
          () => new ListBuilder<SolutionServiceCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CustomerReservationCsv)]),
          () => new ListBuilder<CustomerReservationCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(ServiceAccountingCsv)]),
          () => new ListBuilder<ServiceAccountingCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(VisorReaderCsv)]),
          () => new ListBuilder<VisorReaderCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(SavedLabelCsv)]),
          () => new ListBuilder<SavedLabelCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<ContractServiceDraftCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ServiceCenterCsv)]),
          () => new ListBuilder<ServiceCenterCsv>())
      ..addBuilderFactory(
          const FullType(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<String>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ClientCsv)]),
          () => new ListBuilder<ClientCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(DiscountCsv)]),
          () => new ListBuilder<DiscountCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CenterConveniencesCsv)]),
          () => new ListBuilder<CenterConveniencesCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CenterBpCsv)]),
          () => new ListBuilder<CenterBpCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(EventCsv)]),
          () => new ListBuilder<EventCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CenterPlanCsv)]),
          () => new ListBuilder<CenterPlanCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(String)]),
          () => new ListBuilder<String>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<ClientRequestCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(AcquisitionCostCsv)]),
          () => new ListBuilder<AcquisitionCostCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(QuotationCsv)]),
          () => new ListBuilder<QuotationCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<CustomerReservationCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(VisorClientCsv)]),
          () => new ListBuilder<VisorClientCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(VisorReaderCsv)]),
          () => new ListBuilder<VisorReaderCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(VisorIdentifierCsv)]),
          () => new ListBuilder<VisorIdentifierCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(WifiLogCsv)]),
          () => new ListBuilder<WifiLogCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(WifiStationCsv)]),
          () => new ListBuilder<WifiStationCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(AttributionLogCsv)]),
          () => new ListBuilder<AttributionLogCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CenterConnectionCsv)]),
          () => new ListBuilder<CenterConnectionCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CenterIpCsv)]),
          () => new ListBuilder<CenterIpCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CenterPrinterCsv)]),
          () => new ListBuilder<CenterPrinterCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CenterBayCsv)]),
          () => new ListBuilder<CenterBayCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(PresenceLogCsv)]),
          () => new ListBuilder<PresenceLogCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(BankAccountCsv)]),
          () => new ListBuilder<BankAccountCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(AccountingFileLogCsv)]),
          () => new ListBuilder<AccountingFileLogCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(String)]),
          () => new ListBuilder<String>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CenterDiscountGridCsv)]),
          () => new ListBuilder<CenterDiscountGridCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(String)]),
          () => new ListBuilder<String>())
      ..addBuilderFactory(
          ...
          () => new ListBuilder<SavedLabelCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(FloorPlanCsv)]),
          () => new ListBuilder<FloorPlanCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CenterDiscountCsv)]),
          () => new ListBuilder<CenterDiscountCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CenterOpeningDaysCsv)]),
          () => new ListBuilder<CenterOpeningDaysCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CenterAssetsInner)]),
          () => new ListBuilder<CenterAssetsInner>())
      ..addBuilderFactory(
          ...
          () => new ListBuilder<DiscountCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ServiceCsv)]),
          () => new ListBuilder<ServiceCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(TypologyRateCsv)]),
          () => new ListBuilder<TypologyRateCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(SavedLabelCsv)]),
          () => new ListBuilder<SavedLabelCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ServiceShapeCsv)]),
          () => new ListBuilder<ServiceShapeCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList,
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<ScheduleDesktopJsonld>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(SourceCsv)]),
          () => new ListBuilder<SourceCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(SourceCsv)]),
          () => new ListBuilder<SourceCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<Discount>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(StaffAccountCsv)]),
          () => new ListBuilder<StaffAccountCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(RightCsv)]),
          () => new ListBuilder<RightCsv>())
      ..addBuilderFactory(
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(IndividualCsvEnterpriseSearchEnterpriseExport)
          ]),
          () =>
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(IndividualCsvEnterpriseSearchEnterpriseRead)
          ]),
      ...
      ..addBuilderFactory(
          const FullType(BuiltList, const [
            const FullType(IndividualEnterpriseSearchEnterpriseExport)
          ]),
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<DocumentCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(ContractCodeCsv)]),
          () => new ListBuilder<ContractCodeCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CustomerReservationCsv)]),
          () => new ListBuilder<CustomerReservationCsv>())
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<TypologyRateCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(CommitmentRateCsv)]),
          () => new ListBuilder<CommitmentRateCsv>())
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(CenterDiscountGridCsv)]),
          () => new ListBuilder<CenterDiscountGridCsv>())
      ...
      ..addBuilderFactory(
          ...
          () => new ListBuilder<VisorIdentifierCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(VisorLogClientCsv)]),
          () => new ListBuilder<VisorLogClientCsv>())
      ..addBuilderFactory(
          const FullType(
      ...
      ..addBuilderFactory(
          const FullType(
              BuiltList, const [const FullType(WifiStationBssidCsv)]),
          () => new ListBuilder<WifiStationBssidCsv>())
      ..addBuilderFactory(
          const FullType(BuiltList, const [const FullType(WifiLogJsonld)]),
          () => new ListBuilder<WifiLogJsonld>())
      ..addBuilderFactory(
