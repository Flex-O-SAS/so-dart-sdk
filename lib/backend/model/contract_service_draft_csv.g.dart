...
part of 'contract_service_draft_csv.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$ContractServiceDraftCsv extends ContractServiceDraftCsv {
  @override
  final ContractDraftCsv? contract;
  @override
  ...
  @override
  final CustomServiceDetailDraftCsv? customServiceDetail;
  @override
  final BuiltList<ContractServiceUserDraftCsv>? contractServiceUsers;
  @override
  final int? capacity;
  @override
  ...
  factory _$ContractServiceDraftCsv(
          [void Function(ContractServiceDraftCsvBuilder)? updates]) =>
      (new ContractServiceDraftCsvBuilder()..update(updates))._build();

  _$ContractServiceDraftCsv._(
      {this.contract,
      this.commitment,
      this.owner,
      this.service,
  ...
  @override
  ContractServiceDraftCsv rebuild(
          void Function(ContractServiceDraftCsvBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ContractServiceDraftCsvBuilder toBuilder() =>
      new ContractServiceDraftCsvBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ContractServiceDraftCsv &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ContractServiceDraftCsv')
...
class ContractServiceDraftCsvBuilder
    implements
        Builder<ContractServiceDraftCsv, ContractServiceDraftCsvBuilder> {
  _$ContractServiceDraftCsv? _$v;

  ContractDraftCsvBuilder? _contract;
  ContractDraftCsvBuilder get contract =>
      _$this._contract ??= new ContractDraftCsvBuilder();
  set contract(ContractDraftCsvBuilder? contract) =>
  ...
  CustomServiceDetailDraftCsvBuilder? _customServiceDetail;
  CustomServiceDetailDraftCsvBuilder get customServiceDetail =>
      _$this._customServiceDetail ??= new CustomServiceDetailDraftCsvBuilder();
  set customServiceDetail(
          CustomServiceDetailDraftCsvBuilder? customServiceDetail) =>
      _$this._customServiceDetail = customServiceDetail;

  ListBuilder<ContractServiceUserDraftCsv>? _contractServiceUsers;
  ListBuilder<ContractServiceUserDraftCsv> get contractServiceUsers =>
      _$this._contractServiceUsers ??=
          new ListBuilder<ContractServiceUserDraftCsv>();
  set contractServiceUsers(
          ListBuilder<ContractServiceUserDraftCsv>? contractServiceUsers) =>
  ...
  ContractServiceDraftCsvBuilder() {
    ContractServiceDraftCsv._defaults(this);
  }

  ContractServiceDraftCsvBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(ContractServiceDraftCsv other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ContractServiceDraftCsv;
  }

  @override
  void update(void Function(ContractServiceDraftCsvBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ContractServiceDraftCsv build() => _build();

  _$ContractServiceDraftCsv _build() {
    _$ContractServiceDraftCsv _$result;
    try {
      _$result = _$v ??
          new _$ContractServiceDraftCsv._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ContractServiceDraftCsv', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
