...
ApiEnterprisesGetCollection200Response
    _$ApiEnterprisesGetCollection200ResponseFromJson(
        ...
        $checkedCreate(
          ...
          ($checkedConvert) {
            ...
            final val = ApiEnterprisesGetCollection200Response(
              member: $checkedConvert(
                  'member',
                  (v) => (v as List<dynamic>)
                      .map((e) => EnterpriseJsonldEnterpriseSearchEnterpriseRead
...
Map<String, dynamic> _$ApiEnterprisesGetCollection200ResponseToJson(
        ApiEnterprisesGetCollection200Response instance) =>
    <String, dynamic>{
