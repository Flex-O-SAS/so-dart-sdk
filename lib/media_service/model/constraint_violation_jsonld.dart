...
/// * [instance] 
@BuiltValue()
abstract class ConstraintViolationJsonld implements HydraItemBaseSchema, Built<ConstraintViolationJsonld, ConstraintViolationJsonldBuilder> {
  ...
  factory ConstraintViolationJsonld([void updates(ConstraintViolationJsonldBuilder b)]) = _$ConstraintViolationJsonld;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ConstraintViolationJsonldBuilder b) => b
      ..status = 422;

  @BuiltValueSerializer(custom: true)
  static Serializer<ConstraintViolationJsonld> get serializer => _$ConstraintViolationJsonldSerializer();
}

class _$ConstraintViolationJsonldSerializer implements PrimitiveSerializer<ConstraintViolationJsonld> {
  @override
  final Iterable<Type> types = const [ConstraintViolationJsonld, _$ConstraintViolationJsonld];
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.violations != null) {
      ...
      yield serializers.serialize(
        object.violations,
        specifiedType: const FullType(BuiltList, [FullType(ConstraintViolationViolationsInner)]),
      );
    }
