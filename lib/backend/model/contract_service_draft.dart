...
part 'contract_service_draft.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class ContractServiceDraft implements Built<ContractServiceDraft, ContractServiceDraftBuilder> {
  @BuiltValueField(wireName: r'contract')
  ContractDraft? get contract;
  ...
  CustomServiceDetailDraft? get customServiceDetail;

  @BuiltValueField(wireName: r'contractServiceUsers')
  BuiltList<ContractServiceUserDraft>? get contractServiceUsers;
  ...
  ContractServiceDraft._();

  factory ContractServiceDraft([void updates(ContractServiceDraftBuilder b)]) = _$ContractServiceDraft;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ContractServiceDraftBuilder b) => b
      ..quantity = 1
      ..type = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<ContractServiceDraft> get serializer => _$ContractServiceDraftSerializer();
}

class _$ContractServiceDraftSerializer implements PrimitiveSerializer<ContractServiceDraft> {
  @override
  final Iterable<Type> types = const [ContractServiceDraft, _$ContractServiceDraft];

  @override
  final String wireName = r'ContractServiceDraft';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ContractServiceDraft object, {
    ...
    if (object.contract != null) {
      ...
      yield serializers.serialize(
        object.contract,
        specifiedType: const FullType(ContractDraft),
      );
    }
    ...
    if (object.customServiceDetail != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType.nullable(CustomServiceDetailDraft),
      );
    }
    if (object.contractServiceUsers != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(ContractServiceUserDraft)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required ContractServiceDraftBuilder result,
      ...
      switch (key) {
        ...
        case r'contractServiceUsers':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(ContractServiceUserDraft)]),
          ) as BuiltList<ContractServiceUserDraft>;
  ...
  @override
  ContractServiceDraft deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ContractServiceDraftBuilder();
