...
/// * [updatedAt] 
@BuiltValue()
abstract class BrokerJsonld implements Built<BrokerJsonld, BrokerJsonldBuilder> {
  ...
  BuiltList<EventJsonld>? get events;
  ...
  factory BrokerJsonld([void updates(BrokerJsonldBuilder b)]) = _$BrokerJsonld;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(BrokerJsonldBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<BrokerJsonld> get serializer => _$BrokerJsonldSerializer();
}

class _$BrokerJsonldSerializer implements PrimitiveSerializer<BrokerJsonld> {
  @override
  final Iterable<Type> types = const [BrokerJsonld, _$BrokerJsonld];

  @override
  final String wireName = r'BrokerJsonld';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.events != null) {
      ...
      yield serializers.serialize(
        object.events,
        specifiedType: const FullType(BuiltList, [FullType(EventJsonld)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required BrokerJsonldBuilder result,
  ...
  @override
  BrokerJsonld deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = BrokerJsonldBuilder();
