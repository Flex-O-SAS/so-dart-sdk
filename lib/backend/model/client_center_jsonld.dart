...
part 'client_center_jsonld.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class ClientCenterJsonld implements Built<ClientCenterJsonld, ClientCenterJsonldBuilder> {
  ...
  BuiltList<PaymentMethodJsonld>? get paymentMethods;
  ...
  BuiltList<SsidJsonld>? get ssids;
  ...
  ClientCenterJsonld._();

  factory ClientCenterJsonld([void updates(ClientCenterJsonldBuilder b)]) = _$ClientCenterJsonld;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ClientCenterJsonldBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ClientCenterJsonld> get serializer => _$ClientCenterJsonldSerializer();
}

class _$ClientCenterJsonldSerializer implements PrimitiveSerializer<ClientCenterJsonld> {
  @override
  final Iterable<Type> types = const [ClientCenterJsonld, _$ClientCenterJsonld];

  @override
  final String wireName = r'ClientCenterJsonld';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ClientCenterJsonld object, {
    ...
    if (object.paymentMethods != null) {
      ...
      yield serializers.serialize(
        ...
        specifiedType: const FullType(BuiltList, [FullType(PaymentMethodJsonld)]),
      );
    }
    ...
    if (object.ssids != null) {
      ...
      yield serializers.serialize(
        object.ssids,
        specifiedType: const FullType(BuiltList, [FullType(SsidJsonld)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required ClientCenterJsonldBuilder result,
      ...
      switch (key) {
        ...
        case r'paymentMethods':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType(BuiltList, [FullType(PaymentMethodJsonld)]),
          ) as BuiltList<PaymentMethodJsonld>;
  ...
  @override
  ClientCenterJsonld deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ClientCenterJsonldBuilder();
