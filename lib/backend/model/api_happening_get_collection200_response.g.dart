...
ApiHappeningGetCollection200Response
    _$ApiHappeningGetCollection200ResponseFromJson(Map<String, dynamic> json) =>
        $checkedCreate(
          'ApiHappeningGetCollection200Response',
          json,
          ($checkedConvert) {
            ...
            final val = ApiHappeningGetCollection200Response(
              member: $checkedConvert(
                  'member',
                  (v) => (v as List<dynamic>)
                      .map((e) => HappeningJsonldHappeningSearch.fromJson(
...
Map<String, dynamic> _$ApiHappeningGetCollection200ResponseToJson(
        ApiHappeningGetCollection200Response instance) =>
    <String, dynamic>{
