...
/// * [updatedAt] 
@BuiltValue()
abstract class PluginCsv implements Built<PluginCsv, PluginCsvBuilder> {
  @BuiltValueField(wireName: r'label')
  String? get label;

  @BuiltValueField(wireName: r'module')
  ModuleCsv? get module;
  ...
  factory PluginCsv([void updates(PluginCsvBuilder b)]) = _$PluginCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PluginCsvBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PluginCsv> get serializer => _$PluginCsvSerializer();
}

class _$PluginCsvSerializer implements PrimitiveSerializer<PluginCsv> {
  @override
  final Iterable<Type> types = const [PluginCsv, _$PluginCsv];

  @override
  final String wireName = r'PluginCsv';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.module != null) {
      ...
      yield serializers.serialize(
        object.module,
        specifiedType: const FullType(ModuleCsv),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required PluginCsvBuilder result,
  ...
  @override
  PluginCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PluginCsvBuilder();
