...
part 'endorsement_link_draft.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class EndorsementLinkDraft implements Built<EndorsementLinkDraft, EndorsementLinkDraftBuilder> {
  @BuiltValueField(wireName: r'endorsement')
  ContractDraft? get endorsement;
  ...
  EndorsementLinkDraft._();

  factory EndorsementLinkDraft([void updates(EndorsementLinkDraftBuilder b)]) = _$EndorsementLinkDraft;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(EndorsementLinkDraftBuilder b) => b
      ..reason = 1;

  @BuiltValueSerializer(custom: true)
  static Serializer<EndorsementLinkDraft> get serializer => _$EndorsementLinkDraftSerializer();
}

class _$EndorsementLinkDraftSerializer implements PrimitiveSerializer<EndorsementLinkDraft> {
  @override
  final Iterable<Type> types = const [EndorsementLinkDraft, _$EndorsementLinkDraft];

  @override
  final String wireName = r'EndorsementLinkDraft';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    EndorsementLinkDraft object, {
  ...
  void _deserializeProperties(
    ...
    required EndorsementLinkDraftBuilder result,
  ...
  @override
  EndorsementLinkDraft deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = EndorsementLinkDraftBuilder();
