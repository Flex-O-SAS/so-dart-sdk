...
part of 'visor_log_client_jsonld.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$VisorLogClientJsonld extends VisorLogClientJsonld {
  @override
  final VisorClientJsonld? visorClient;
  @override
  final VisorIdentifierJsonld? visorIdentifier;
  @override
  final VisorReaderJsonld? visorReader;
  @override
  final int? eventType;
  @override
  final int? eventId;
  ...
  factory _$VisorLogClientJsonld(
          [void Function(VisorLogClientJsonldBuilder)? updates]) =>
      (new VisorLogClientJsonldBuilder()..update(updates))._build();

  _$VisorLogClientJsonld._(
      {this.visorClient,
  ...
  @override
  VisorLogClientJsonld rebuild(
          void Function(VisorLogClientJsonldBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  VisorLogClientJsonldBuilder toBuilder() =>
      new VisorLogClientJsonldBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is VisorLogClientJsonld &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'VisorLogClientJsonld')
...
class VisorLogClientJsonldBuilder
    implements Builder<VisorLogClientJsonld, VisorLogClientJsonldBuilder> {
  _$VisorLogClientJsonld? _$v;

  VisorClientJsonldBuilder? _visorClient;
  VisorClientJsonldBuilder get visorClient =>
      _$this._visorClient ??= new VisorClientJsonldBuilder();
  set visorClient(VisorClientJsonldBuilder? visorClient) =>
      _$this._visorClient = visorClient;

  VisorIdentifierJsonldBuilder? _visorIdentifier;
  VisorIdentifierJsonldBuilder get visorIdentifier =>
      _$this._visorIdentifier ??= new VisorIdentifierJsonldBuilder();
  set visorIdentifier(VisorIdentifierJsonldBuilder? visorIdentifier) =>
      _$this._visorIdentifier = visorIdentifier;

  VisorReaderJsonldBuilder? _visorReader;
  VisorReaderJsonldBuilder get visorReader =>
      _$this._visorReader ??= new VisorReaderJsonldBuilder();
  set visorReader(VisorReaderJsonldBuilder? visorReader) =>
  ...
  VisorLogClientJsonldBuilder() {
    VisorLogClientJsonld._defaults(this);
  }

  VisorLogClientJsonldBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(VisorLogClientJsonld other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$VisorLogClientJsonld;
  }

  @override
  void update(void Function(VisorLogClientJsonldBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  VisorLogClientJsonld build() => _build();

  _$VisorLogClientJsonld _build() {
    _$VisorLogClientJsonld _$result;
    try {
      _$result = _$v ??
          new _$VisorLogClientJsonld._(
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'VisorLogClientJsonld', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
