...
ApiDevicesGetCollection200ResponseSearchMappingInner
    _$ApiDevicesGetCollection200ResponseSearchMappingInnerFromJson(
            Map<String, dynamic> json) =>
        $checkedCreate(
          'ApiDevicesGetCollection200ResponseSearchMappingInner',
          json,
          ($checkedConvert) {
            final val = ApiDevicesGetCollection200ResponseSearchMappingInner(
...
Map<String, dynamic>
    _$ApiDevicesGetCollection200ResponseSearchMappingInnerToJson(
            ApiDevicesGetCollection200ResponseSearchMappingInner instance) =>
        <String, dynamic>{
