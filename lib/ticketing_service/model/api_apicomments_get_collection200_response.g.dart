...
ApiApicommentsGetCollection200Response
    _$ApiApicommentsGetCollection200ResponseFromJson(
        ...
        $checkedCreate(
          ...
          ($checkedConvert) {
            ...
            final val = ApiApicommentsGetCollection200Response(
              member: $checkedConvert(
                  'member',
                  (v) => (v as List<dynamic>)
                      .map((e) => CommentJsonldCommentRead.fromJson(
...
Map<String, dynamic> _$ApiApicommentsGetCollection200ResponseToJson(
        ApiApicommentsGetCollection200Response instance) =>
    <String, dynamic>{
