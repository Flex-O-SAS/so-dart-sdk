...
import 'package:so_dart_sdk/backend/model/device_csv.dart';
import 'package:built_value/built_value.dart';
import 'package:built_value/serializer.dart';

part 'account_csv.g.dart';
...
/// * [updatedAt] 
@BuiltValue()
abstract class AccountCsv implements Built<AccountCsv, AccountCsvBuilder> {
  ...
  BuiltList<DeviceCsv>? get devices;
  ...
  factory AccountCsv([void updates(AccountCsvBuilder b)]) = _$AccountCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AccountCsvBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AccountCsv> get serializer => _$AccountCsvSerializer();
}

class _$AccountCsvSerializer implements PrimitiveSerializer<AccountCsv> {
  @override
  final Iterable<Type> types = const [AccountCsv, _$AccountCsv];

  @override
  final String wireName = r'AccountCsv';
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.devices != null) {
      ...
      yield serializers.serialize(
        object.devices,
        specifiedType: const FullType(BuiltList, [FullType(DeviceCsv)]),
      );
    }
  ...
  void _deserializeProperties(
    ...
    required AccountCsvBuilder result,
  ...
  @override
  AccountCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = AccountCsvBuilder();
