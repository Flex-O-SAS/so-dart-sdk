...
part 'contract_indexing_log_csv.g.dart';

/// ContractIndexingLogCsv
///
/// Properties:
/// * [contract] 
...
/// * [updatedAt] 
@BuiltValue()
abstract class ContractIndexingLogCsv implements Built<ContractIndexingLogCsv, ContractIndexingLogCsvBuilder> {
  ...
  ContractIndexingLogCsv._();

  factory ContractIndexingLogCsv([void updates(ContractIndexingLogCsvBuilder b)]) = _$ContractIndexingLogCsv;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ContractIndexingLogCsvBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ContractIndexingLogCsv> get serializer => _$ContractIndexingLogCsvSerializer();
}

class _$ContractIndexingLogCsvSerializer implements PrimitiveSerializer<ContractIndexingLogCsv> {
  @override
  final Iterable<Type> types = const [ContractIndexingLogCsv, _$ContractIndexingLogCsv];

  @override
  final String wireName = r'ContractIndexingLogCsv';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ContractIndexingLogCsv object, {
  ...
  void _deserializeProperties(
    ...
    required ContractIndexingLogCsvBuilder result,
  ...
  @override
  ContractIndexingLogCsv deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ContractIndexingLogCsvBuilder();
